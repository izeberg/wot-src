package net.wg.frontline.gui.battle.views.stats.components
{
   ...
   public class FrontlineFullStatsTableCtrl extends FrontlineStatsDataProviderBaseCtrl implements ISquadHandler
   {
      ...
      public function updateColorBlind() : void
      {
         ...
         var _loc1_:int = this._table.team1PlayerList.rowCount;
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_)
         {
         ...
         _loc1_ = this._table.team2PlayerList.rowCount;
         _loc3_ = 0;
         while(_loc3_ < _loc1_)
         {
      ...
      public function set isRenderingAvailable(param1:Boolean) : void
      {
         ...
         this.sortingIfVisible();
         var _loc3_:int = this._table.team2PlayerList.rowCount;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
         ...
         _loc3_ = this._table.team1PlayerList.rowCount;
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         {
