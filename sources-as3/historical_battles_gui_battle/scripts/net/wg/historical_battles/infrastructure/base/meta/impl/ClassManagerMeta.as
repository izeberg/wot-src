package net.wg.historical_battles.infrastructure.base.meta.impl
{
   ...
   import net.wg.historical_battles.gui.battle.views.minimap.HBFullMapContainer;
   ...
   public class ClassManagerMeta
   {
      ...
      public static const NET_WG_HISTORICAL_BATTLES_GUI_BATTLE_VIEWS_MINIMAP_HBFULLMAP:Class = HBFullMap;
      
      public static const NET_WG_HISTORICAL_BATTLES_GUI_BATTLE_VIEWS_MINIMAP_HBFULLMAPCONTAINER:Class = HBFullMapContainer;
      ...
      public static const NET_WG_HISTORICAL_BATTLES_GUI_BATTLE_VIEWS_PLAYERLIVES_HBPLAYERLIVES:Class = HBPlayerLives;
      ...
      public static const NET_WG_HISTORICAL_BATTLES_INFRASTRUCTURE_BASE_META_IMPL_CLASSMANAGEREXTENSIONBATTLEDAMAGEINDICATORMETA:Class = ClassManagerExtensionBattleDamageIndicatorMeta;
      
      public static const NET_WG_HISTORICAL_BATTLES_INFRASTRUCTURE_BASE_META_IMPL_CLASSMANAGEREXTENSIONBATTLEDIRECTIONINDICATORMETA:Class = ClassManagerExtensionBattleDirectionIndicatorMeta;
      
      public static const NET_WG_HISTORICAL_BATTLES_INFRASTRUCTURE_BASE_META_IMPL_CLASSMANAGEREXTENSIONBATTLEMARKERSMETA:Class = ClassManagerExtensionBattleMarkersMeta;
