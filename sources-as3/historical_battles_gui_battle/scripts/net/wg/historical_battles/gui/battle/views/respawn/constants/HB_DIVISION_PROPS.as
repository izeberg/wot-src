package net.wg.historical_battles.gui.battle.views.respawn.constants
{
   ...
   public class HB_DIVISION_PROPS
   {
      ...
      private static const ICON_BASE_SIZE:uint = 110;
      
      {
         ...
         ICONS_SCALE[HB_STAGE_SIZE.EXTRA_SMALL] = 64 / ICON_BASE_SIZE;
         ICONS_SCALE[HB_STAGE_SIZE.SMALL] = 64 / ICON_BASE_SIZE;
         ICONS_SCALE[HB_STAGE_SIZE.MEDIUM] = 80 / ICON_BASE_SIZE;
         ICONS_SCALE[HB_STAGE_SIZE.LARGE] = 80 / ICON_BASE_SIZE;
         ICONS_SCALE[HB_STAGE_SIZE.EXTRA_LARGE] = 120 / ICON_BASE_SIZE;
         LABEL_POS[HB_STAGE_SIZE.EXTRA_SMALL] = new Point(256,10);
         LABEL_POS[HB_STAGE_SIZE.SMALL] = new Point(256,10);
         LABEL_POS[HB_STAGE_SIZE.MEDIUM] = new Point(346,16);
         LABEL_POS[HB_STAGE_SIZE.LARGE] = new Point(346,16);
         LABEL_POS[HB_STAGE_SIZE.EXTRA_LARGE] = new Point(464,8);
         NAME_POS[HB_STAGE_SIZE.EXTRA_SMALL] = new Point(256,30);
         NAME_POS[HB_STAGE_SIZE.SMALL] = new Point(256,30);
         NAME_POS[HB_STAGE_SIZE.MEDIUM] = new Point(346,44);
         NAME_POS[HB_STAGE_SIZE.LARGE] = new Point(346,44);
         NAME_POS[HB_STAGE_SIZE.EXTRA_LARGE] = new Point(464,52);
         EMBLEM_X[HB_STAGE_SIZE.EXTRA_SMALL] = 186;
         EMBLEM_X[HB_STAGE_SIZE.SMALL] = 186;
         EMBLEM_X[HB_STAGE_SIZE.MEDIUM] = 256;
         EMBLEM_X[HB_STAGE_SIZE.LARGE] = 256;
         EMBLEM_X[HB_STAGE_SIZE.EXTRA_LARGE] = 330;
         EMBLEM_Y[HB_STAGE_SIZE.EXTRA_SMALL] = 7;
         EMBLEM_Y[HB_STAGE_SIZE.SMALL] = 7;
         EMBLEM_Y[HB_STAGE_SIZE.MEDIUM] = 14;
         EMBLEM_Y[HB_STAGE_SIZE.LARGE] = 14;
         EMBLEM_Y[HB_STAGE_SIZE.EXTRA_LARGE] = 7;
