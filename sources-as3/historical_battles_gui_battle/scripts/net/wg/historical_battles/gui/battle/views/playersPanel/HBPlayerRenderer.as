package net.wg.historical_battles.gui.battle.views.playersPanel
{
   ...
   public class HBPlayerRenderer extends BattleUIComponent
   {
      ...
      private static const VEHICLE_DESC_TF_MIN_WIDTH:uint = 40;
      ...
      public var stateMC:BattleAtlasSprite = null;
      ...
      override protected function initialize() : void
      {
         ...
         this.chatCommandState.visible = false;
      }
      ...
      override protected function configUI() : void
      {
         ...
         this.vehicleDescTF.autoSize = TextFieldAutoSize.LEFT;
         if(this.hitMc != null)
         {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INVALID_PLAYER_STATE))
         {
            ...
            _loc1_ = this._playerState == HB_PLAYERS_PANEL_ITEM_STATE.SPAWN_VEHICLE_SELECTED;
            this.vehSelectedCheck.visible = _loc1_;
            this.stateMC.imageName = !!_loc1_ ? BATTLEATLAS.HB_SELECTED : BATTLEATLAS.HB_HOVER;
         }
      }
      ...
      protected function validateData() : void
      {
         ...
         this.vehicleDescTF.width = VEHICLE_DESC_TF_MIN_WIDTH;
