package net.wg.historical_battles.gui.battle.views.consumablesPanel
{
   ...
   import net.wg.historical_battles.infrastructure.base.meta.IHBConsumablesPanelMeta;
   import net.wg.historical_battles.infrastructure.base.meta.impl.HBConsumablesPanelMeta;
   ...
   public class HBConsumablesPanel extends HBConsumablesPanelMeta implements IHBConsumablesPanelMeta
   {
      ...
      override protected function addAbilitySlot(param1:int, param2:HBAbilitySlotVO) : void
      {
         var _loc4_:int = 0;
         var _loc3_:IConsumablesButton = renderers[param1];
         if(_loc3_ != null)
         {
            if(!(_loc3_ is HBAbilityButton))
            {
               _loc4_ = renderers.indexOf(_loc3_);
               if(_loc4_ != -1)
               {
                  renderers.splice(_loc4_,1);
         ...
         super.as_addEquipmentSlot(param1,param2.keyCode,param2.sfKeyCode,param2.quantity,param2.timeRemaining,param2.reloadingTime,param2.iconPath,param2.tooltipText,0);
      }
      
      override protected function addRoleAbilitySlot(param1:int, param2:HBAbilitySlotVO) : void
      {
         var _loc4_:int = 0;
         var _loc3_:IConsumablesButton = renderers[param1];
         if(_loc3_ != null)
         {
            if(!(_loc3_ is HBRoleAbilityButton))
            {
               _loc4_ = renderers.indexOf(_loc3_);
               if(_loc4_ != -1)
               {
