package net.wg.historical_battles.gui.battle.views.playersPanel.components.healthBar
{
   ...
   public class HBHealthBar extends BattleUIComponent
   {
      ...
      public var hp:BattleAtlasSprite = null;
      ...
      override protected function initialize() : void
      {
         ...
         this.bg.imageName = BATTLEATLAS.HB_HP_BG;
      }
      ...
      override protected function draw() : void
      {
         ...
         if(this._isEnemiesPanel)
         {
            if(isInvalid(INV_IS_BLIND))
            {
               ...
               this.hp.imageName = !!this._isBlindEnabled ? BATTLEATLAS.HB_HP_ENEMY_BLIND : BATTLEATLAS.HB_HP_ENEMY;
            }
         }
         else if(isInvalid(INV_IS_CURRENT))
         {
            this.fx.isCurrentPlayer = this._isCurrentPlayer;
            this.hp.imageName = !!this._isCurrentPlayer ? BATTLEATLAS.HB_HP_CURRENT : BATTLEATLAS.HB_HP_ALLY;
         }
