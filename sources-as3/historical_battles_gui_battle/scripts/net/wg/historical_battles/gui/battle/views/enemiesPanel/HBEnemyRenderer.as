package net.wg.historical_battles.gui.battle.views.enemiesPanel
{
   ...
   public class HBEnemyRenderer extends BattleUIComponent
   {
      ...
      public var glow:BattleAtlasSprite = null;
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            ...
            this.glow.imageName = !!App.colorSchemeMgr.getIsColorBlindS() ? BATTLEATLAS.HB_GLOW_PURPLE : BATTLEATLAS.HB_GLOW_RED;
         }
      }
      ...
      private function onColorSchemasUpdatedHandler(param1:ColorSchemeEvent) : void
      {
         ...
         this.glow.imageName = !!_loc2_ ? BATTLEATLAS.HB_GLOW_PURPLE : BATTLEATLAS.HB_GLOW_RED;
      }
   }
}
