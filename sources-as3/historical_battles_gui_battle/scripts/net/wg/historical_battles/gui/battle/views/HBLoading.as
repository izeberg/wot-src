package net.wg.historical_battles.gui.battle.views
{
   ...
   import net.wg.historical_battles.infrastructure.base.meta.IHBLoadingMeta;
   import net.wg.historical_battles.infrastructure.base.meta.impl.HBLoadingMeta;
   ...
   public class HBLoading extends HBLoadingMeta implements IHBLoadingMeta
   {
      ...
      public var hintBgLoader:Image = null;
      ...
      {
         super.initialize();
         this.hintBgLoader.cacheType = ImageCacheTypes.NOT_USE_CACHE;
         this.hintBgLoader.addEventListener(Event.CHANGE,this.onHintBgLoaderChangeHandler);
      }
      ...
      override protected function onDispose() : void
      {
         ...
         this.hintBgLoader.removeEventListener(Event.CHANGE,this.onHintBgLoaderChangeHandler);
      ...
      private function validateSize() : void
      {
         ...
         if(this.hintBgLoader.ready)
         {
            _loc1_ = Math.max(this._stageHeight / StageSizeBoundaries.HEIGHT_1440,this._stageWidth / StageSizeBoundaries.WIDTH_2560);
            this.hintBgLoader.width = StageSizeBoundaries.WIDTH_2560 * _loc1_ | 0;
            this.hintBgLoader.height = StageSizeBoundaries.HEIGHT_1440 * _loc1_ | 0;
            this.hintBgLoader.x = this._stageWidth - this.hintBgLoader.width >> 1;
            this.hintBgLoader.y = this._stageHeight - this.hintBgLoader.height >> 1;
         }
      ...
      private function onHintBgLoaderChangeHandler(param1:Event) : void
      {
         if(this.hintBgLoader.ready)
         {
            invalidateSize();
