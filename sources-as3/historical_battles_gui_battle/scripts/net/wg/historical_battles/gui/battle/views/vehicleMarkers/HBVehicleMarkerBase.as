package net.wg.historical_battles.gui.battle.views.vehicleMarkers
{
   ...
   public class HBVehicleMarkerBase extends BattleUIComponent implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      public function HBVehicleMarkerBase()
      {
      ...
      protected function updatePartsVisibility() : Vector.<Boolean>
      {
         ...
         return new <Boolean>[_loc5_ || _loc6_,_loc3_,_loc4_,_loc2_,_loc1_,_loc8_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.visible && this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible];
      }
