package net.wg.historical_battles.gui.battle.views.postmortemPanel
{
   ...
   import net.wg.historical_battles.infrastructure.base.meta.IHBPostmortemPanelMeta;
   import net.wg.historical_battles.infrastructure.base.meta.impl.HBPostmortemPanelMeta;
   ...
   public class HBPostmortemPanel extends HBPostmortemPanelMeta implements IHBPostmortemPanelMeta
   {
      ...
      override protected function configUI() : void
      {
         ...
         exitToHangarDescTF.text = INGAME_GUI.POSTMORTEM_TIPS_EXITHANGAR_TEXT_HB;
      }
