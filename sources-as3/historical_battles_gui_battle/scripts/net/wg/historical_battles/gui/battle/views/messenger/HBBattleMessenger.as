package net.wg.historical_battles.gui.battle.views.messenger
{
   import net.wg.gui.battle.views.battleMessenger.BattleMessage;
   import net.wg.historical_battles.infrastructure.base.meta.IHBBattleMessengerMeta;
   import net.wg.historical_battles.infrastructure.base.meta.impl.HBBattleMessengerMeta;
   ...
   public class HBBattleMessenger extends HBBattleMessengerMeta implements IHBBattleMessengerMeta
   {
      ...
      public function as_toggleReadingModer(param1:Boolean) : void
      {
         ...
         receiverField.visible = bg.visible = !param1;
