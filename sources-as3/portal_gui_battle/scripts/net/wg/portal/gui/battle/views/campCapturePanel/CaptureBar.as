package net.wg.portal.gui.battle.views.campCapturePanel
{
   ...
   public class CaptureBar extends MovieClip implements IDisposable
   {
      ...
      private static const ANIMATE_STEP_TIME_MIN_PRESET:Number = 1000;
      
      private static const ANIMATE_RATE_FACTOR_MIN_PRESET:Number = ANIMATE_STEP_TIME_MIN_PRESET / ANIMATE_STEP_TIME;
      ...
      private var _isMinPreset:Boolean = false;
      ...
      public function setData(param1:Number, param2:Number, param3:String, param4:String, param5:Number, param6:String, param7:String, param8:Boolean = false) : void
      {
         ...
         this._isMinPreset = param8;
         this.updateCaptureData(param5,false,false,1,param6,param7,param4,param3,_loc9_);
      }
      ...
      private function animateProgress(param1:Number, param2:Number, param3:Boolean, param4:Number) : void
      {
         ...
         {
            _loc5_ = !!this._isMinPreset ? Number(ANIMATE_STEP_TIME_MIN_PRESET) : Number(ANIMATE_STEP_TIME);
            ...
            if(this._isMinPreset)
            {
               this._easeParam *= ANIMATE_RATE_FACTOR_MIN_PRESET;
            }
            this._currentEaseLen = this._currentEaseArray.length;
            this._currentEaseStep = 0;
            this._animateRate = !!this._isMinPreset ? Number(param4 * ANIMATE_RATE_FACTOR_MIN_PRESET) : Number(param4);
            this._scheduler.scheduleRepeatableTask(this.animationStepHandler,_loc5_,int.MAX_VALUE);
         }
