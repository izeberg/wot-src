package net.wg.portal.gui.battle.ribbonsPanel
{
   ...
   public class RibbonsPool implements IDisposable
   {
      ...
      public function RibbonsPool(param1:DisplayObjectContainer, param2:DisplayObjectContainer, param3:DisplayObjectContainer, param4:Array, param5:Function)
      {
         ...
         var _loc11_:Vector.<RibbonCtrl> = null;
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         super();
         ...
         while(_loc14_ < _loc6_)
         {
            ...
            _loc11_ = new Vector.<RibbonCtrl>(0);
            this._mapVectorsWithItemsByRibbonType[_loc8_] = _loc11_;
            _loc12_ = _loc9_.getStartCountItemsInPool();
            _loc13_ = 0;
            while(_loc13_ < _loc12_)
            {
               _loc11_.push(this.createRibbonCtrl(_loc8_));
               _loc13_++;
            }
            _loc14_++;
         }
