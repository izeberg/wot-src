package net.wg.portal.gui.battle.views.minimap.components.entries.vehicle
{
   ...
   public class VehicleMinimapEntry extends BattleUIComponent implements IVehicleMinimapEntry
   {
      ...
      private static const LABEL_ALLY:String = "ally";
      ...
      public function setGUILabel(param1:String) : void
      {
         ...
         {
            this._guiLabel = this.useGuiColorOverrides(param1);
      ...
      public function setVehicleInfo(param1:Number, param2:String, param3:String, param4:String, param5:String) : void
      {
         ...
         {
            this._guiLabel = this.useGuiColorOverrides(param4);
      ...
      private function useGuiColorOverrides(param1:String) : String
      {
         if(param1.search(LABEL_ALLY) != Values.DEFAULT_INT)
         {
            param1 = param1.replace(LABEL_ALLY,LABEL_TEAM_KILLER);
         }
         return param1;
      }
