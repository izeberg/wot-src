package net.wg.portal.gui.battle.views.playersPanel.components.healthBar
{
   ...
   public class HealthBar extends BattleUIComponent
   {
      ...
      private static const RESPAWN_LABEL:String = "respawn";
       
      
      public var fxMask:MovieClip = null;
      
      public var fx:HealthBarFx = null;
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(InvalidationType.DATA))
         {
            ...
            {
               this.bg.gotoAndStop(RESPAWN_LABEL);
            }
            else
            {
               this.bg.gotoAndStop(REGULAR_LABEL);
            }
         }
         if(isInvalid(INV_IS_CURRENT))
         {
