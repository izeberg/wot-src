package net.wg.portal.gui.battle.views.playersPanel
{
   ...
   public class PlayerRenderer extends BattleUIComponent
   {
      ...
      private static const VEHICLE_DESCR_X:int = 171;
      
      private static const VEHICLE_TYPE_X:int = 155;
       
      
      public var playerName:PlayerName = null;
      
      public var hitMc:MovieClip;
      
      public var dynamicSquad:DynamicSquad = null;
      
      public var vehicleLvlTF:TextField = null;
      ...
      public var respawnTimer:RespawnTimer = null;
      
      private var _data:PlayerInfoVO = null;
      ...
      override protected function configUI() : void
      {
         ...
         this.vehicleLvlTF.blendMode = BlendMode.SCREEN;
         if(this.hitMc != null)
         {
         ...
         this.voiceMuteIcon.imageName = BATTLEATLAS.PORTAL_VOICE_MUTE_ICON;
         this.voiceMuteBg.imageName = BATTLEATLAS.PORTAL_VOICE_MUTE_BG;
         this.chatMuteIcon.imageName = BATTLEATLAS.PORTAL_CHAT_MUTE_ICON;
      ...
      protected function validateColors() : void
      {
         ...
         this.vehicleLvlTF.textColor = this.playerName.textColor = !!_loc1_ ? int(COLOR_CURRENT) : int(COLOR_ALLY);
         this.vehicleType.color = !!_loc1_ ? VehicleType.ORANGE : VehicleType.WHITE;
         ...
         this.dynamicSquad.alpha = this.playerName.alpha = this.vehicleType.alpha = this.vehicleDescTF.alpha = this.vehicleLvlTF.alpha = _loc3_;
      }
      ...
      protected function validateData() : void
      {
         ...
         this.vehicleDescTF.x = VEHICLE_DESCR_X;
         this.vehicleType.x = VEHICLE_TYPE_X;
         ...
         this.vehicleLvlTF.text = this._data.vehicleLvlRoman;
         this.updateSquad();
      ...
      public function set data(param1:Object) : void
      {
         ...
         this._data = PlayerInfoVO(param1);
         if(this._data)
         {
