package net.wg.portal.gui.battle.views.campCapturePanel
{
   ...
   public class CampCaptureProgress extends TeamCaptureProgress
   {
      
      private static const SCALE_9_GRID:Rectangle = new Rectangle(10,1,1,34);
      ...
      public function CampCaptureProgress()
      {
