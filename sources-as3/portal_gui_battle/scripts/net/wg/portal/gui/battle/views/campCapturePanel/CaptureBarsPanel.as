package net.wg.portal.gui.battle.views.campCapturePanel
{
   ...
   public class CaptureBarsPanel extends TeamBasesPanelMeta implements ITeamBasesPanelMeta
   {
      
      private static const RENDERER_HEIGHT:Number = 34;
      
      private static const ASSERT_MSG:String = "[CaptureBarsPanel] Can\'t find teamCaptureBar with id=";
      ...
      private var _captureBars:Vector.<CaptureBar> = null;
      
      private var _cachedBars:Vector.<CaptureBar> = null;
      ...
      public function CaptureBarsPanel()
      {
         this._colorSchemeMgr = App.colorSchemeMgr;
         super();
         this._captureBars = new Vector.<CaptureBar>();
         this._cachedBars = new Vector.<CaptureBar>();
         var _loc1_:uint = 0;
      ...
      private static function sortBarsFn(param1:CaptureBar, param2:CaptureBar) : Number
      {
      ...
      public function as_add(param1:Number, param2:Number, param3:String, param4:String, param5:Number, param6:String, param7:String, param8:Boolean) : void
      {
         var _loc10_:CaptureBar = null;
         ...
         var _loc9_:CaptureBar = this._cachedBars.pop();
         addChild(_loc9_);
      ...
      public function as_remove(param1:Number) : void
      {
         ...
         var teamCaptureBar:CaptureBar = this._captureBars[index];
      ...
      {
         var _loc3_:CaptureBar = this._captureBars[param1];
         if(_loc3_ != null)
         {
            _loc3_.y = param2;
         }
      ...
      private function disposeBar(param1:CaptureBar, param2:Boolean) : void
      {
         param1.dispose();
         if(param2)
         {
      ...
      private function getCaptureBarById(param1:Number) : CaptureBar
      {
         var _loc3_:int = 0;
         var _loc2_:CaptureBar = null;
      ...
      {
         var _loc1_:CaptureBar = App.utils.classFactory.getComponent(this.getBarLinkage(),CaptureBar);
