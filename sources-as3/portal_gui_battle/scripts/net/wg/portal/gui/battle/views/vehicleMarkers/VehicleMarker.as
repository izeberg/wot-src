package net.wg.portal.gui.battle.views.vehicleMarkers
{
   ...
   public class VehicleMarker extends BattleUIComponent implements IMarkerManagerHandler, IVehicleMarkerInvokable
   {
      ...
      protected function updatePartsVisibility() : Vector.<Boolean>
      {
         ...
         var _loc5_:Boolean = this.getIsPartVisible(DAMAGE_PANEL);
         var _loc6_:Boolean = !this.vehicleDestroyed && this._isVehicleDistVisible && this.getIsPartVisible(VEHICLE_DIST);
         this.vehicleDist.visible = _loc6_;
         if(_loc1_ && this._lastPlayerName != this.model.pName)
         {
         ...
         this.playerNameField.visible = _loc1_;
         if(_loc2_)
         {
            this.vehicleNameField.text = this.model.vType;
         }
         this.vehicleNameField.visible = _loc2_;
         if(_loc3_)
         {
            this.healthBar.currHealth = this.model.currHealth;
         }
         this.healthBar.visible = _loc3_;
         this.hpField.visible = _loc4_;
         if(this.vehicleDestroyed)
         {
            this.setDestroyedColorForHP();
         }
         this.setHealthText();
         this.hitLabel.visible = _loc5_;
         this.hitExplosion.visible = _loc5_;
         var _loc7_:int = (!!_loc1_ ? 1 : 0) + (!!_loc2_ ? 1 : 0);
         if(!_loc3_)
         {
            _loc7_ += !!_loc4_ ? 1 : 0;
            if(_loc7_ > 0)
            {
               _loc7_ += SHADOW_TYPE_HBAR_OFFSET;
            }
         }
         if(_loc7_ > 0)
         {
            _loc8_ = SHADOW_POSITIONS[_loc7_];
            this.vmManager.drawGraphics(VMAtlasItemName.getShadowName(_loc7_),this.bgShadow.graphics,_loc8_);
         ...
         return new <Boolean>[_loc3_ || _loc4_,_loc1_,_loc2_,_loc6_,this.model.squadIndex != 0,this._isFlagShown,this.statusContainer.isVisible(),this.actionMarker.isVisible(),this.vehicleMarkerHoverMC.visible];
      }
      ...
      {
         return [this.hpField,this.playerNameField,this.vehicleNameField,this.vehicleDist,this.squadIcon,this.marker2,this.statusContainer,this.actionMarker,this.vehicleMarkerHoverMC];
      }
      
      protected function prepareCrossOffsets() : Array
      {
         return [null,new CrossOffset(this.hpField,-3),new CrossOffset(this.playerNameField,-7,this.hpField,-3),new CrossOffset(this.vehicleNameField,-4,this.playerNameField,-4),null,null,new CrossOffset(this.vehicleNameField,3),new CrossOffset(this.statusContainer,-25),new CrossOffset(this.actionMarker,-52)];
      }
      ...
      {
         var _loc2_:String = null;
         if(this._markerColor == VehicleMarkersConstants.COLOR_RED)
         {
            _loc2_ = VehicleMarkerFlags.DAMAGE_FROM[param1];
