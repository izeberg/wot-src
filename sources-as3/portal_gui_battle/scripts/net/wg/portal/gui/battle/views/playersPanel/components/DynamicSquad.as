package net.wg.portal.gui.battle.views.playersPanel.components
{
   ...
   public class DynamicSquad extends BattleUIComponent
   {
      ...
      private function validateData() : void
      {
         ...
         this.icon.imageName = !!this._isPlayerInSquad ? BATTLEATLAS.PORTAL_SQUAD_GOLD : BATTLEATLAS.PORTAL_SQUAD_SILVER;
      }
