package net.wg.portal.gui.battle.ribbonsPanel
{
   ...
   public class RibbonCtrl implements IDisposable
   {
      ...
      private static const UPDATE_ANIM:String = "update";
      
      private static const SHOW_MST_ANIM:String = "showMST";
      
      private static const HIDE_LEFT_ANIM:String = "hideLeft";
      
      private static const HIDE_BOTTOM_ANIM:String = "hideBottom";
      
      private static const DEFAULT_STATE:String = "default";
      
      private static const SHIFT_ANIM:String = "shiftPosition";
      
      private static const LINKAGE_RIBBON_ICONS:String = "PortalRibbonIconsUI";
      
      private static const LINKAGE_RIBBON_TEXT:String = "PortalRibbonTextsUI";
      ...
      public function RibbonCtrl(param1:RibbonSettings, param2:Function)
      {
         ...
         this._icons = _loc3_.getComponent(LINKAGE_RIBBON_ICONS,RibbonIcons);
         this._texts = _loc3_.getComponent(LINKAGE_RIBBON_TEXT,RibbonTexts);
