package net.wg.portal.gui.battle.ribbonsPanel
{
   ...
   public class RibbonIcons extends SimpleDisposable
   {
      ...
      private static const EVENT_POSTFIX:String = "Portal";
      
      private static const ICONS_OVERRIDE_MAP:Object = {};
      
      {
         ICONS_OVERRIDE_MAP[BATTLEATLAS.RIBBONS_DAMAGE_BY_THUNDER_STRIKE] = BATTLEATLAS.RIBBONS_SENTINEL_ENEMY;
      }
      ...
      public function updateIcons() : void
      {
         ...
         var _loc4_:String = this.getAtlasItemNamePostfix(_loc1_.bgType);
         this._atlasMgr.drawGraphics(_loc3_,_loc2_ + _loc4_,this._background.graphics);
         this._atlasMgr.drawGraphics(_loc3_,this.getIconName(this._ribbonSettings.getIcon()) + _loc4_,this._ribbonTypeIcon.graphics);
         this.updateDamageIcon();
      }
      
      private function getIconName(param1:String) : String
      {
         if(ICONS_OVERRIDE_MAP[param1])
         {
            return ICONS_OVERRIDE_MAP[param1];
         }
         return param1;
      }
      
      private function getAtlasItemNamePostfix(param1:String) : String
      {
         return param1 == RibbonColors.GREEN ? EVENT_POSTFIX : Values.EMPTY_STR;
      }
