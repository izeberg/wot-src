package net.wg.portal.gui.battle.views.playersPanel.components
{
   ...
   public class PlayerName extends BattleUIComponent
   {
      ...
      private var _playerNameWidth:int = 105;
      
      private var _playerNameBadgeActiveWidth:int = 76;
      ...
      public function setData(param1:PlayerInfoVO) : void
      {
      ...
      private function validateName() : void
      {
         ...
         var _loc1_:Boolean = App.utils.commons.formatPlayerName(this.playerNameTF,this._userProps);
         mouseEnabled = _loc1_;
