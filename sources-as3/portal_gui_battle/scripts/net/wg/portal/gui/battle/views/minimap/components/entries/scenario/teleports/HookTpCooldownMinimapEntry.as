package net.wg.portal.gui.battle.views.minimap.components.entries.scenario.teleports
{
   ...
   public class HookTpCooldownMinimapEntry extends ScenarioMinimapEntry
   {
       
      
      public function HookTpCooldownMinimapEntry()
      {
         super();
      }
      ...
      {
         marker.iconType = BATTLEATLAS.HOOK_TP_COOL_DOWN;
