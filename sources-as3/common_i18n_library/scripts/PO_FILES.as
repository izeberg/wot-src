package
{
   public class PO_FILES
   {
      ...
      public static const ALL_ENUM:Array = [TEXT_ACCOUNT_COMPLETION,TEXT_ACCOUNT_DASHBOARD,TEXT_ACHIEVEMENTS,TEXT_ACHIEVEMENTS_PAGE,TEXT_ADVANCED_ACHIEVEMENTS,TEXT_AOGAS,TEXT_ARENAS,TEXT_ARTEFACTS,TEXT_AWARDS,TEXT_BADGE,TEXT_BAN_REASON,TEXT_BATTLE_HINTS,TEXT_BATTLE_MATTERS,TEXT_BATTLE_PASS,TEXT_BATTLE_RESULTS,TEXT_BATTLE_ROYALE,TEXT_BLUEPRINTS,TEXT_CAT,TEXT_CHAT,TEXT_CHINA_CREW,TEXT_CHINA_VEHICLES,TEXT_CLANS,TEXT_CLAN_SUPPLY,TEXT_COLLECTIONS,TEXT_COLLECTION_BATTLE_PASS_10,TEXT_COLLECTION_BATTLE_PASS_11,TEXT_COLLECTION_BATTLE_PASS_12,TEXT_COMMON,TEXT_COMP7,TEXT_CONTROLS,TEXT_CREW,TEXT_CREW_BOOKS,TEXT_CREW_HELP,TEXT_CREW_OPERATIONS,TEXT_CREW_PERKS,TEXT_CREW_SKINS,TEXT_CREW_WIDGET,TEXT_CURRENCY_RESERVES,TEXT_CYBERSPORT,TEXT_CZECH_CREW,TEXT_CZECH_VEHICLES,TEXT_DATETIME_FORMATS,TEXT_DEATH_CAM,TEXT_DEMOUNT_KIT,TEXT_DEVELOPMENT,TEXT_DIALOGS,TEXT_DOGTAGS,TEXT_ELITE_WINDOW,TEXT_ENVIRONMENT_TOOLTIPS,TEXT_EPIC_BATTLE,TEXT_ERROR_DLG,TEXT_EVENT,TEXT_EVENT_BOARDS,TEXT_EXCLUDED_MAPS,TEXT_FALLOUT,TEXT_FAQ,TEXT_FORTIFICATIONS,TEXT_FRANCE_CREW,TEXT_FRANCE_VEHICLES,TEXT_GAME_LOADING,TEXT_GB_CREW,TEXT_GB_VEHICLES,TEXT_GERMANY_CREW,TEXT_GERMANY_VEHICLES,TEXT_HANGAR,TEXT_IGR_VEHICLES,TEXT_INGAME_GUI,TEXT_INGAME_HELP,TEXT_INVITES,TEXT_ITALY_CREW,TEXT_ITALY_VEHICLES,TEXT_ITEM_TYPES,TEXT_JAPAN_CREW,TEXT_JAPAN_VEHICLES,TEXT_LOBBY_HELP,TEXT_LOOTBOXES,TEXT_LOOTBOX_ANNIVERSARYCN,TEXT_LOOTBOX_SYSTEM,TEXT_LORE,TEXT_MANUAL,TEXT_MAPBOX,TEXT_MAPS_TRAINING,TEXT_MARATHON,TEXT_MATCHMAKER,TEXT_MENU,TEXT_MESSENGER,TEXT_MINICLIENT,TEXT_MODE_SELECTOR,TEXT_MOTIVATION_QUESTS,TEXT_MULTINATIONAL_VEHICLES,TEXT_NATIONS,TEXT_NY,TEXT_NY_HANGAR_NAME,TEXT_OFFERS,TEXT_PERSONAL_EXCHANGE_RATES,TEXT_PERSONAL_MISSIONS,TEXT_PERSONAL_MISSIONS_DETAILS,TEXT_PERSONAL_RESERVES,TEXT_PLATOON,TEXT_PLAYER_SUBSCRIPTIONS,TEXT_POINTS_OF_INTEREST,TEXT_POLAND_CREW,TEXT_POLAND_VEHICLES,TEXT_PREBATTLE,TEXT_PREMACC,TEXT_PRESTIGE,TEXT_PROFILE,TEXT_PROGRESSIVE_REWARD,TEXT_QUESTS,TEXT_RANKED_BATTLES,TEXT_READABLE_KEY_NAMES,TEXT_RECERTIFICATION_FORM,TEXT_RESOURCE_WELL,TEXT_ROMAN_NUMERALS,TEXT_SELECTABLE_REWARD,TEXT_SENIORITY_AWARDS,TEXT_SESSION_STATS,TEXT_SETTINGS,TEXT_STATIC_QUESTS,TEXT_STORAGE,TEXT_STORE,TEXT_SUBSCRIPTION,TEXT_SWEDEN_CREW,TEXT_SWEDEN_VEHICLES,TEXT_SYSTEM_MESSAGES,TEXT_TANK_CAROUSEL_FILTER,TEXT_TANK_SETUP,TEXT_TIPS,TEXT_TOOLTIPS,TEXT_TOYS,TEXT_TUTORIAL,TEXT_USA_CREW,TEXT_USA_VEHICLES,TEXT_USSR_CREW,TEXT_USSR_CREW_EN,TEXT_USSR_VEHICLES,TEXT_VEHICLE_CUSTOMIZATION,TEXT_VEHICLE_CUSTOMIZATION_CN,TEXT_VEHICLE_PREVIEW,TEXT_VEH_COMPARE,TEXT_VEH_POST_PROGRESSION,TEXT_W2C,TEXT_WAITING,TEXT_WINBACK];
