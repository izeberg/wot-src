package
{
   public class ITEM_TYPES
   {
      ...
      public static const SHELL_KINDSABBREVIATION_ENUM:Array = [SHELL_KINDSABBREVIATION_ARMOR_PIERCING,SHELL_KINDSABBREVIATION_ARMOR_PIERCING_CR,SHELL_KINDSABBREVIATION_ARMOR_PIERCING_FSDS,SHELL_KINDSABBREVIATION_ARMOR_PIERCING_HE,SHELL_KINDSABBREVIATION_HOLLOW_CHARGE,SHELL_KINDSABBREVIATION_HIGH_EXPLOSIVE,SHELL_KINDSABBREVIATION_FLAME,SHELL_KINDSABBREVIATION_SMOKE];
      
      public static const SHELL_KINDS_ENUM:Array = [SHELL_KINDS_ARMOR_PIERCING,SHELL_KINDS_ARMOR_PIERCING_CR,SHELL_KINDS_ARMOR_PIERCING_FSDS,SHELL_KINDS_ARMOR_PIERCING_FSDS_SHORT,SHELL_KINDS_ARMOR_PIERCING_HE,SHELL_KINDS_HOLLOW_CHARGE,SHELL_KINDS_HIGH_EXPLOSIVE,SHELL_KINDS_FLAME];
