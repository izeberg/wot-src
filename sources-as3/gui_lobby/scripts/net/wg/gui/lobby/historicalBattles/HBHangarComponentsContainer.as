package net.wg.gui.lobby.historicalBattles
{
   ...
   public class HBHangarComponentsContainer extends Sprite implements IDisposable
   {
      ...
      private static const MAIN_REWARD_WIDGET:String = "mainRewardWidget";
      ...
      public var mainRewardWidget:GFInjectComponent = null;
      ...
      public function HBHangarComponentsContainer()
      {
         ...
         this.mainRewardWidget = new GFInjectComponent();
         this.mainRewardWidget.name = MAIN_REWARD_WIDGET;
         this.mainRewardWidget.setManageSize(true);
         addChild(this.hangarVignette);
         addChild(this.divisionPanel);
         addChild(this.orderWidget);
         addChild(this.shopWidget);
         addChild(this.mainRewardWidget);
      ...
      public function updateStage(param1:int, param2:int) : void
      {
         ...
         this.mainRewardWidget.width = HB_HANGAR_COMPONENTS.MAIN_REWARD_WIDGET_SIZE[_loc3_.name].width;
         this.mainRewardWidget.height = HB_HANGAR_COMPONENTS.MAIN_REWARD_WIDGET_SIZE[_loc3_.name].height;
         this.mainRewardWidget.x = param1 - this.mainRewardWidget.width | 0;
         this.mainRewardWidget.y = HB_HANGAR_COMPONENTS.MAIN_REWARD_WIDGET_SIZE[_loc3_.name].top;
