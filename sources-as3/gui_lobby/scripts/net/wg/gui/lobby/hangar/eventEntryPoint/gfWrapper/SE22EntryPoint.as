package net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper
{
   ...
   public class SE22EntryPoint extends SE22EntryPointMeta implements ISE22EntryPointMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         if(isInvalid(INV_COUNTER))
         {
            ...
            if(this._isNew)
            {
               ...
               this._scheduler.scheduleOnNextFrame(this._scheduler.scheduleOnNextFrame,this._counterManager.setCounter,this,_loc1_,null,_loc2_);
            }
         }
      }
      ...
      {
         this._scheduler.cancelTask(this._scheduler.scheduleOnNextFrame);
         this._scheduler.cancelTask(this._counterManager.setCounter);
         this._counterManager.removeCounter(this);
         this._counterManager.disposeCountersForContainer(MENU.COUNTER_NEWCOUNTER);
         this._counterManager.disposeCountersForContainer(CounterManager.EXCLAMATION_COUNTER_VALUE);
