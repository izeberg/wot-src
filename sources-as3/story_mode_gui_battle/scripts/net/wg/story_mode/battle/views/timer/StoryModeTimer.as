package net.wg.story_mode.battle.views.timer
{
   ...
   public class StoryModeTimer extends StoryModeTimerMeta implements IStoryModeTimerMeta
   {
      ...
      override protected function draw() : void
      {
         ...
         {
            _loc1_ = StringUtils.isEmpty(this._header);
            if(StringUtils.isEmpty(this._time))
            {
               this.hintTask.y = !!_loc1_ ? Number(HINT_NO_TIMER_NO_HEADER_Y) : Number(HINT_NO_TIMER_Y);
            }
            else
            {
               this.hintTask.y = !!_loc1_ ? Number(HINT_TIMER_NO_HEADER_Y) : Number(HINT_TIMER_Y);
            }
