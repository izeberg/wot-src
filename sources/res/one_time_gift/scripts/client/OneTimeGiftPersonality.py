...
from one_time_gift.gui.shared.event_dispatcher import tryEnterOneTimeGift
from one_time_gift.gui.gui_constants import ONE_TIME_GIFT_TOOLTIP_SET
from gui.shared.system_factory import registerScaleformLobbyPackages, registerMessengerClientFormatter, registerLobbyTooltipsBuilders, registerSeniorityAwardFollowers, registerSeniorityAwardViewClass
from one_time_gift.gui.impl.lobby.seniority_reward_award_view import OTGSeniorityRewardAwardView
from one_time_gift.gui.impl.lobby.user_missions import registerOneTimeGiftEventBanner
...
def preInit():
    ...
    registerLobbyTooltipsBuilders((
     (
      'one_time_gift.gui.scaleform.daapi.view.tooltips.tooltip_builders', ONE_TIME_GIFT_TOOLTIP_SET),))
    registerOneTimeGiftEventBanner()
    registerSeniorityAwardFollowers(tryEnterOneTimeGift)
    registerSeniorityAwardViewClass(OTGSeniorityRewardAwardView)
