...
class OneTimeGiftConfig(namedtuple('OneTimeGiftConfig', ('isEnabled', 'startTime', 'endTime', 'remindTime',
                                 'remindBattlesAmount', 'newbieDistinctionTime',
                                 'additionalRewards', 'collectorsCompensation'))):
    __slots__ = ()
