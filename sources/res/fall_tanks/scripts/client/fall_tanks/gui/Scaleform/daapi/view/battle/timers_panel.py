...
class FallTanksTimersPanel(TimersPanel):
    ...
    def _generateMainTimersData(self):
        return [
         self._getNotificationTimerData(_VEHICLE_EVACUATION_TIMER_TYPE, _EVACUATION_ICON, _EVACUATION_LINKAGE, _COLORS.CUSTOM, text=backport.text(R.strings.fall_tanks.statusNotificationTimer.evacuation()), iconOffsetY=self._OFFSET),
