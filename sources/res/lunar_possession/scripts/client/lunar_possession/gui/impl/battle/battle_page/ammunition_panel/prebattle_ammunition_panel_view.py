...
from lunar_possession.gui.impl.battle.battle_page.ammunition_panel.ammunition_panel import LunarPrebattleAmmunitionPanel
...
class LunarPrebattleAmmunitionPanelView(ViewImpl):
    ...
    def __init__(self, vehicle, *args):
        ...
        super(LunarPrebattleAmmunitionPanelView, self).__init__(settings)
    ...
    @property
    def viewModel(self):
        return super(LunarPrebattleAmmunitionPanelView, self).getViewModel()
    ...
    def _initialize(self, *args, **kwargs):
        super(LunarPrebattleAmmunitionPanelView, self)._initialize()
        self.__addListeners()
    ...
    def _finalize(self):
        ...
        super(LunarPrebattleAmmunitionPanelView, self)._finalize()

    def _onLoading(self, currShellCD, nextShellCD, state, *args, **kwargs):
        super(LunarPrebattleAmmunitionPanelView, self)._onLoading(*args, **kwargs)
        self.__ammunitionPanel = LunarPrebattleAmmunitionPanel(self.viewModel.ammunitionPanel, self.__vehicle, ctx={'state': state})
    ...
    def _onLoaded(self, *args, **kwargs):
        super(LunarPrebattleAmmunitionPanelView, self)._onLoaded(*args, **kwargs)
