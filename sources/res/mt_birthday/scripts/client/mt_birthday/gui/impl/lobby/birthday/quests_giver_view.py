...
class QuestsGiverView(ViewImpl):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.mt_birthday.lobby.tooltips.DescriptionRulesTooltip():
            return DescriptionRulesTooltip(event.getArgument('minLevel', MIN_VEHICLE_LEVEL), event.getArgument('maxLevel', MAX_VEHICLE_LEVEL), event.getArgument('battleTypes', ''))
