...
def _webHandlers():
    ...
    return webApiCollection(request.RequestWebApi, ui.OpenWindowWebApi, ui.CloseWindowWebApi, ui.OpenTabWebApi, ui.UtilWebApi, sound_web_api.SoundWebApi, sound_web_api.HangarSoundWebApi, sound_web_api.SoundStateWebApi, ShopWebApi, PlatformWebApi, ReactiveCommunicationWebApi, GoldWagonWebApi)
