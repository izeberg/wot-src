...
class AttachComponent(Block, CGFMeta):
    ...
    def _execute(self):
        ...
        _componentsMap = {'DynamicModelComponent': (
                                   GenericComponents.DynamicModelComponent, vehicle.appearance.compoundModel), 
           'RedirectorComponent': (
...
class AttachToEntity(Block, CGFMeta):
    ...
    def _execute(self):
        ...
        _componentsMap = {'DynamicModelComponent': (
                                   GenericComponents.DynamicModelComponent, appearance.compoundModel), 
           'RedirectorComponent': (
