...
EVENT_CONFIG = ComponentsConfig(config=(
 ...
 (
  ...
  (
   BATTLE_VIEW_ALIASES.EVENT_HUNTER_RESPAWN,
...
class WhiteTigerBattlePage(ClassicPage, ISpawnListener):
    ...
    __OPPONENT_SWITCH_VALUES = {WT_TAGS.WT_BOSS: 'SWITCH_ext_WT_vo_opponent_of_hunters_krieger', WT_TAGS.WT_BOSS_2025: 'SWITCH_ext_WT_vo_opponent_of_hunters_lemarten'}
    ...
    def showSpawnPoints(self):
        ...
        visibleComponents = {
         ...
         BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET} | self._spawnVisibleComponents
    ...
    def __setVisibilityInitBattlePeriod(self):
        visibleComponents = {
         BATTLE_VIEW_ALIASES.PLAYERS_PANEL_EVENT, BATTLE_VIEW_ALIASES.EVENT_BOSS_WIDGET}
    ...
    def _onRegisterFlashComponent(self, viewPy, alias):
        ...
        if alias in (BATTLE_VIEW_ALIASES.EVENT_HUNTER_RESPAWN,
         BATTLE_VIEW_ALIASES.EVENT_BOSS_TELEPORT):
