...
WT_VIDEOS = ('boss_portal_idle.usm', 'boss_portal_open.usm', 'hunter_portal_idle.usm',
             'hunter_portal_open.usm', 'wt_intro.usm', 'wt_outro.usm', '2_Projet_57_Ampere_v001.usm',
             'CVT_Spider_v001.usm', 'Czolg_P_Wz_46_3dst_Verbesserter_v001.usm', 'Projekt_SAT_v003.usm',
             'Projet_57_v001.usm', 'MAIN_2_Projet_57_Ampere_v001.usm', 'MAIN_CVT_Spider_v001.usm',
             'MAIN_Czolg_P_Wz_46_3dst_Verbesserter_v001.usm', 'MAIN_Projekt_SAT_v003.usm',
             'MAIN_Projet_57_v001.usm', 'vehicle_common.usm', 'vehicle1_v001.usm',
             'vehicle2_v001.usm', 'vehicle3_v001.usm', 'vehicle4_v001.usm', 'vehicle5_v001.usm')
...
class WhiteTigerController(IWhiteTigerController, Notifiable, SeasonProvider, IGlobalListener):
    ...
    def hasEnoughTickets(self, bossType, useQuickTicket=True):
        ...
        if bossType == WT_TAGS.WT_BOSS_2025:
            return self.getTicket2025Count() >= config.tickets2025ToDraw
        return False
