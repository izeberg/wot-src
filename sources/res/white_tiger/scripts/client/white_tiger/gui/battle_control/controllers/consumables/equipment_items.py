...
class _WTUnionStrength(_TriggerItem):
    ...
    def getTags(self):
        return (
         BATTLE_CONSUMABLES_PANEL_TAGS.EVENT_PASSIVE_ITEM,)
...
def _eventItemFactory(descriptor, quantity, stage, timeRemaining, totalTime, tag=None):
    ...
    if descriptor.name.lower().endswith('unionstrength_wt'):
        return _WTUnionStrength(descriptor, quantity, stage, timeRemaining, totalTime, tag)
...
def _wtEquipmentItemFactory(descriptor, quantity, stage, timeRemaining, totalTime, tag=None):
    ...
    if descriptor.name.lower().endswith('medkit_wt'):
        return _WTMedKitItem(descriptor, quantity, stage, timeRemaining, totalTime, tag)
