...
WT_MATCHMAKER_STATS_NAMES = ('wtCountBossWins', 'wtBossDequeuedByUserCount', 'wtHunterDequeuedByUserCount',
                             'wtHunterKickedFromQueueCount', 'wtBossKickedFromQueueCount',
                             'wtBossWaitTime', 'wtBossesWithQuickTicketCount', 'wtCompletedBattlesCount',
                             'wtHunterWaitTime')
