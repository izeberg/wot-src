...
class MarkerNyView(HOHangarMarkerView):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.advent_calendar.mono.lobby.markers.entry_point_marker(), model=MarkerNyViewModel(), args=args, kwargs=kwargs)
