...
class CustomizationObjects(object):
    ...
    WITHOUT_MEGA = (
     FIR, LIGHTS, INSTALLATIONS, FAIR, SKATING, ATTRACTIONS)
    ALL = WITHOUT_MEGA
    WITH_RANDOM = ALL + (RANDOM_TYPE,)
    PANEL_OBJECTS_ORDER = (
     FAIR, INSTALLATIONS, SKATING, FIR, LIGHTS, ATTRACTIONS)
...
class ToyTypes(object):
    ...
    USUAL_TYPES = (
     TOP, GARLAND_FIR, BALL, FLOOR, LIGHTS_HOUSES, LIGHTS_FIR, SCULPTURE, KIOSK, PAVILION, SKATING, ATTRACTION)
    MEGA = ()
    PET = (
     PET_TOY, PET_FOOD, PET_BED, PET_INTERACTIVE)
    ALL = USUAL_TYPES + PET
