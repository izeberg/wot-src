import logging, SoundGroups, enum, typing, AnimationSequence, BigWorld
...
class NyAtmosphereLevelUpView(ViewImpl):
    __slots__ = ('__tooltips', '__rewards', '__currentRewardId', '__currentRewardType',
                 '__completedLevels', '__completedCollections', '__backCallback',
                 '__voiceOverEnabled')
