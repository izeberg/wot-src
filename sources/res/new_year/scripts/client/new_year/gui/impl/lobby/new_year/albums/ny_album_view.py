...
class NyAlbumView(HistorySubModelPresenter):
    ...
    def createToolTipContent(self, event, ctID):
        if ctID == R.views.new_year.lobby.new_year.tooltips.NyAlbumDecorationTooltip():
            ...
            if ctID == R.views.new_year.lobby.new_year.tooltips.NyCollectionBonusTooltip():
                return self._currentAlbumPresenter.createCollectionBonusTooltip()
            if ctID == R.views.new_year.lobby.new_year.tooltips.NyTotalBonusTooltip():
                return NyTotalBonusTooltip()
            return

    def createToolTip(self, event):
        if event.contentID == R.views.common.tooltip_window.backport_tooltip_content.BackportTooltipContent():
            return self._currentAlbumPresenter.createAwardTooltip(event)
