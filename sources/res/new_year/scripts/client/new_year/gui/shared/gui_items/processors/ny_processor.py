...
class ApplyVehicleDiscountProcessor(Processor):
    ...
    def _errorHandler(self, code, errStr='', ctx=None):
        ...
        if clientErrKey:
            return makeError(backport.text(R.strings.ny.systemMessage.applyVehicleDiscount.server_error.dyn(clientErrKey)()))
        return makeError(backport.text(R.strings.ny.systemMessage.applyVehicleDiscount.server_error()))
