...
def getViewSettings():
    ...
    return (
     ViewSettings(HANGAR_ALIASES.COMP7_PRIME_TIME_ALIAS, Comp7PrimeTimeView, getSwfExtensionUrl('comp7', HANGAR_ALIASES.COMP7_PRIME_TIME), WindowLayer.SUB_VIEW, HANGAR_ALIASES.COMP7_PRIME_TIME_ALIAS, ScopeTemplates.LOBBY_SUB_SCOPE, True),
