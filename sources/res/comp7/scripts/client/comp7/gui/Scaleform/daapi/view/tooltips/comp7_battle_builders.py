...
def getTooltipBuilders():
    return (
     DataBuilder(COMP7_BATTLE_TOOLTIPS.COMP7_ROLE_SKILL_BATTLE_TOOLTIP, TOOLTIPS_CONSTANTS.BLOCKS_DEFAULT_UI, RoleSkillBattleTooltipData(Comp7RoleSkillBattleContext())),
