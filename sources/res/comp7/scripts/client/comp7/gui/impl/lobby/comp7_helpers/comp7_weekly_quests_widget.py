...
class Comp7WeeklyQuestsWidgetView(DailyQuestsWidgetView):
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.comp7.lobby.tooltips.WeeklyQuestTooltip():
            return WeeklyQuestTooltip()
        return super(Comp7WeeklyQuestsWidgetView, self).createToolTipContent(event, contentID)
