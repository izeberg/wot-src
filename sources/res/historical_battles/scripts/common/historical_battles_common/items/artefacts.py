...
class HBVehicleNitro(Equipment):
    __slots__ = ('shortDescription', 'longDescription', 'shortFilterAlert', 'longFilterAlert',
                 ...
                 'effects', 'factors', 'cooldownSeconds', 'durationSeconds', 'activeSeconds',
                 'reuseCount')
...
class HBHealPoint(Equipment):
    __slots__ = ('shortDescription', 'longDescription', 'shortFilterAlert', 'longFilterAlert',
                 'tooltipIdentifiers', 'soundNotificationActive', 'cooldownSeconds',
                 'durationSeconds', 'reuseCount', 'radius', 'healPercent', 'effects')
