...
class BattleQuestAwardsView(ViewImpl, IPrbListener):
    ...
    def createToolTipContent(self, event, contentID):
        ...
        if contentID == R.views.historical_battles.lobby.tooltips.HbCompensationRewardTooltip():
            return HbCompensationRewardTooltip(contentID, **self.getTooltipData(event).specialArgs)
