import BigWorld, HBAccountSettings, typing, SoundGroups
...
_FULL_SCREEN_VIEWS = {BATTLE_VIEW_ALIASES.HISTORICAL_BATTLES_STATS_WIDGET, BATTLE_VIEW_ALIASES.RADIAL_MENU,
 BATTLE_VIEW_ALIASES.HISTORICAL_BATTLES_FULL_MAP}
...
class HistoricalBattlePage(ClassicPage):
    ...
    def _toggleFullMap(self, isShow):
        ...
        if isShow and not isVisible:
            ...
            self._setComponentsVisibility(visible={
             BATTLE_VIEW_ALIASES.HISTORICAL_BATTLES_FULL_MAP}, hidden=self._fmToggling)
    ...
    def _toggleRadialMenu(self, isShown, allowAction=True):
        ...
        if radialMenu is None:
            ...
            if isShown and self.__checkCanNotToggleFS(radialMenuLinkage):
                return
            if isShown:
                radialMenu.show()
