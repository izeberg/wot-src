...
class HistoricalBattlesRibbonsPanel(BattleRibbonsPanel):
    ...
    def _getViewData(self):
        return super(HistoricalBattlesRibbonsPanel, self)._getViewData() + [
         [
          _BET.BOMBERS,
          backport.text(R.strings.hb_battle.efficiencyRibbons.bombers())],
         [
          _BET.ARTILLERY,
          backport.text(R.strings.hb_battle.efficiencyRibbons.artillery())],
         [
          _BET.RECEIVED_BOMBERS_DAMAGE,
          backport.text(R.strings.hb_battle.efficiencyRibbons.receivedBombersDamage())],
         [
          _BET.DAMAGE_BY_BOMBERCAS,
          backport.text(R.strings.hb_battle.efficiencyRibbons.bombercas())],
         [
          _BET.DAMAGE_BY_ARTILLERY_ROCKET,
          backport.text(R.strings.hb_battle.efficiencyRibbons.artilleryRocket())],
         [
          _BET.DAMAGE_BY_ARTILLERY_MORTAR,
          backport.text(R.strings.hb_battle.efficiencyRibbons.artilleryMortar())],
         [
          _BET.HB_DEATH_ZONE,
          backport.text(R.strings.hb_battle.efficiencyRibbons.HBDeathZone())],
         [
          _BET.HB_PERSONAL_DEATH_ZONE,
          backport.text(R.strings.hb_battle.efficiencyRibbons.receivedBombersDamage())],
         [
          _BET.DAMAGE_BY_HB_MINEFIELD,
          backport.text(R.strings.hb_battle.efficiencyRibbons.damageByHBMinefield())],
         [
          _BET.HEAL_VEHICLE_APPLIED,
          backport.text(R.strings.hb_battle.efficiencyRibbons.healVehicleApplied())],
         [
          _BET.TOTAL_VEHICLES_HEAL_APPLIED,
          backport.text(R.strings.hb_battle.efficiencyRibbons.TotalVehiclesHealApplied())],
         [
          _BET.HEAL_SELF_VEHICLE_APPLIED,
          backport.text(R.strings.hb_battle.efficiencyRibbons.healSelfVehicleApplied())],
         [
          _BET.DAMAGE_BY_ARTILLERY_ON_YOURSELF,
          backport.text(R.strings.hb_battle.efficiencyRibbons.artilleryOnYourself())],
         [
          _BET.RECEIVED_BY_ARTILLERY_ON_YOURSELF,
          backport.text(R.strings.hb_battle.efficiencyRibbons.artilleryOnYourself())]]
