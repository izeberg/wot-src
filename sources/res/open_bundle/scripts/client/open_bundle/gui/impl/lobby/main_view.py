...
class MainView(ViewImpl):
    ...
    @args2params(str, int, int)
    def __showPreview(self, bonusType, bonusId, styleID):
        if bonusType == 'vehicles':
            ...
            showStylePreview(vehicleCD, style, backCallback=self.__reopen)
        return
    ...
    def __reopen(self):
        ...
        showOpenBundleMainView(self.__bundle.id)
