...
class BaseAbilityEquipment(Equipment, TooltipConfigReader, ArcadeEquipmentConfigReader, AreaMarkerConfigReader):
    __slots__ = ('navmeshGirth', 'heightAboveBase', 'prepareTime', 'respawnTime', 'cooldownTime',
                 'unspotDelay', 'navmeshGirth', 'directVisionRadius', 'visionMinRadius',
                 'detectFromVehicle', 'observationPoints') + TooltipConfigReader._SHARED_TOOLTIPS_CONSUMABLE_SLOTS + ArcadeEquipmentConfigReader._SHARED_ARCADE_SLOTS + AreaMarkerConfigReader._MARKER_SLOTS_
