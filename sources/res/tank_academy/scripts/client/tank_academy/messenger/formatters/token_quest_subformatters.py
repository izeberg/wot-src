...
class TankAcademyAwardsFormatterBase(ServiceChannelFormatter, TokenQuestsSubFormatter):
    ...
    def __buildMessage(self, questID, message):
        ...
        if fmt is not None:
            ...
            settings = self._getGuiSettings(message, template, decorator=TankAcademyAwardsDecorator, auxData={'questID': questID, 'isWithSelectableReward': isWithSelectableReward})
