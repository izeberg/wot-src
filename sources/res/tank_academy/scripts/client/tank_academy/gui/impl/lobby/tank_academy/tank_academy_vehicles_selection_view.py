...
class TankAcademyVehiclesSelectionView(ViewImpl):
    __slots__ = ('__selectableBonus', '__vehiclesByTabKey', '__filters', '__filterPopover',
                 '__offerToken', '__offersByTabKey', '__selectedTabKey', '__questsByOfferToken')
        ...
        for offer in offers:
            ...
            for gift in offer.getAllGifts():
                ...
                if vehicle.intCD in vehicles:
                    continue
                vehicles[vehicle.intCD] = {'vehicle': vehicleBonus, 'giftID': gift.id}
    ...
    def __getOfferTabKey(cls, offer):
        return (
         int(offer.properties.get('giftVehiclesLevel', 0)), cls.__isPremiumOffer(offer))
