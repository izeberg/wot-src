import logging, BigWorld, CGF, Math, typing
...
_CacheItem = typing.NamedTuple('CacheItem', [('gameObject', typing.Optional[CGF.GameObject]),
 (
  'slotComponent', typing.Optional[NySlotComponent]),
 (
  'nodes', typing.List[CGF.GameObject])])
...
class GraphicsPreferenceComponent(object):
    ...
    category = 'New Year'
    graphicsPreset = ComponentProperty(type=CGFMetaTypes.STRING, value=GraphicsPreference.DEFERRED, annotations={'comboBox': {GraphicsPreference.DEFERRED: GraphicsPreference.DEFERRED, GraphicsPreference.FORWARD: GraphicsPreference.FORWARD}})
...
class LobbyCustomizableObjectsManager(CGF.ComponentManager):
    ...
    def updateSlotHighlight(self, slotId, isEnabled):
        ...
        if slotInfo is None:
            ...
            if not slotInfo.slotComponent.hoverEffect:
                return
            if isEnabled:
