...
_FEEDBACK_BY_RATING_VARIANT = {PlayerSatisfactionRating.WORSE: [
                                  R.strings.player_satisfaction.battle.widget.onDislikeTextOptionOne(),
   ...
   PlayerSatisfactionRating.BETTER: [
                                   R.strings.player_satisfaction.battle.widget.onLikeTextOptionOne(),
   ...
   PlayerSatisfactionRating.USUAL: [
                                  R.strings.player_satisfaction.battle.widget.onNeutralText()], 
   PlayerSatisfactionRating.NONE: [
                                 R.strings.player_satisfaction.battle.widget.baseText()]}
...
def getFeedbackResID(ratingVariant, arenaUniqueID):
    ...
    if numOptions == 1:
        return options[0]
    return options[(arenaUniqueID % numOptions)]
