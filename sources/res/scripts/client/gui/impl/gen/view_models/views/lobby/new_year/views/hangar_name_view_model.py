...
class HangarNameViewModel(ViewModel):
    __slots__ = ('onSubmitName', 'onKeepName', 'onChangeAll', 'onChangeTitle', 'onChangeDescription',
                 'onCloseWelcomeScreen', 'onCloseChangeNameScreen')
    ...
    def getIsCameraFlyby(self):
        return self._getBool(4)

    def setIsCameraFlyby(self, value):
    ...
    def _initialize(self):
        ...
        self._addBoolProperty('isCameraFlyby', False)
