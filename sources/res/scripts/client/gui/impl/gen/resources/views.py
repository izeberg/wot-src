...
class Views(DynAccessor):
    ...
    class _winback(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            class _tooltips(DynAccessor):
                __slots__ = ()
                CompensationTooltip = DynAccessor(682)
                SelectableRewardTooltip = DynAccessor(683)
                SelectedRewardsTooltip = DynAccessor(684)
                WidgetTooltipView = DynAccessor(685)

            tooltips = _tooltips()
            WinbackIntroView = DynAccessor(686)
            WinbackRewardView = DynAccessor(687)
            WinbackSelectableRewardView = DynAccessor(688)
            WinbackWidgetView = DynAccessor(689)

        lobby = _lobby()
        ProgressionMainView = DynAccessor(690)

    winback = _winback()
    Anchor = DynAccessor(691)
    ArmoryYardDemoView = DynAccessor(692)

    class _child_views_demo(DynAccessor):
        __slots__ = ()
        ChildDemoView = DynAccessor(693)
        MainView = DynAccessor(694)

    child_views_demo = _child_views_demo()
    Comp7DemoPageView = DynAccessor(695)
    ComponentsDemo = DynAccessor(696)
    DataLayerDemoView = DynAccessor(697)
    DataTrackerDemo = DynAccessor(698)
    DemoContextMenu = DynAccessor(699)
    Easings = DynAccessor(700)
    GameLoadingDebugView = DynAccessor(701)
    GFCharset = DynAccessor(702)
    GFComponents = DynAccessor(703)
    GFDemoPopover = DynAccessor(704)
    GFDemoRichTooltipWindow = DynAccessor(705)
    GFDemoWindow = DynAccessor(706)
    GFHooksDemo = DynAccessor(707)
    GFInjectView = DynAccessor(708)
    GFInputCases = DynAccessor(709)
    GfMarkerDemoView = DynAccessor(710)
    GFSimpleTooltipWindow = DynAccessor(711)
    GFWebSubDemoWindow = DynAccessor(712)

    class _gf_dialogs_demo(DynAccessor):
        __slots__ = ()
        DefaultDialogProxy = DynAccessor(713)
        GFDialogsDemo = DynAccessor(714)

        class _sub_views(DynAccessor):
            __slots__ = ()
            DummyContent = DynAccessor(715)
            DummyFooter = DynAccessor(716)
            DummyIcon = DynAccessor(717)
            DummyStepper = DynAccessor(718)
            DummyTitle = DynAccessor(719)
            DummyTopRight = DynAccessor(720)
    ...
    class _gf_viewer(DynAccessor):
        __slots__ = ()
        GFViewerWindow = DynAccessor(721)

    gf_viewer = _gf_viewer()

    class _igb_demo(DynAccessor):
        __slots__ = ()
        BrowserFullscreenWindow = DynAccessor(722)
        BrowserWindow = DynAccessor(723)
        MainView = DynAccessor(724)

    igb_demo = _igb_demo()
    LocaleDemo = DynAccessor(725)
    MediaWrapperDemo = DynAccessor(726)
    MixBlendMode = DynAccessor(727)
    MixBlendModeAnimation = DynAccessor(728)
    ModeSelectorDemo = DynAccessor(729)
    ModeSelectorToolsetView = DynAccessor(730)
    NewYearLevelUp = DynAccessor(731)
    ...
    class _wgtv(DynAccessor):
        __slots__ = ()
        CustomView = DynAccessor(746)
        WgtvEntityView = DynAccessor(747)
        WgtvKeyframeInfoView = DynAccessor(748)
        WgtvKeyframeView = DynAccessor(749)
        WgtvTimelineView = DynAccessor(750)
        WgtvToolsView = DynAccessor(751)
