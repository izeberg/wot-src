...
class Views(DynAccessor):
    ...
    class _frontline(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            TabInfoView = DynAccessor(658)

            class _tooltips(DynAccessor):
                __slots__ = ()
                LevelReservesTooltip = DynAccessor(659)
                NotEnoughPointsTooltip = DynAccessor(660)
                SkillOrderTooltip = DynAccessor(661)

            tooltips = _tooltips()
            WelcomeView = DynAccessor(662)
    ...
    class _fun_random(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            class _feature(DynAccessor):
                __slots__ = ()
                FunRandomEntryPointView = DynAccessor(663)
                FunRandomHangarWidgetView = DynAccessor(664)
                FunRandomMapsView = DynAccessor(665)
                FunRandomModeSubSelector = DynAccessor(666)
                FunRandomModifiersPanel = DynAccessor(667)
                FunRandomProgression = DynAccessor(668)

            feature = _feature()

            class _tooltips(DynAccessor):
                __slots__ = ()
                FunRandomMapsDomainTooltip = DynAccessor(669)
                FunRandomProgressionTooltipView = DynAccessor(670)
    ...
    class _gui_lootboxes(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            class _gui_lootboxes(DynAccessor):
                __slots__ = ()
                BonusProbabilitiesView = DynAccessor(671)
                EntryPointView = DynAccessor(672)
                KeysWelcomeScreen = DynAccessor(673)
                LootboxesFullStatsView = DynAccessor(674)
                LootBoxesLoseRewardScreen = DynAccessor(675)
                LootBoxesShortStatsView = DynAccessor(676)
                LootboxRewardsView = DynAccessor(677)
                LootboxVideoRewardView = DynAccessor(678)
                OpenBoxErrorView = DynAccessor(679)

                class _shared(DynAccessor):
                    __slots__ = ()
                    AnimationControls = DynAccessor(680)
                    BacklitTransparentButton = DynAccessor(681)
                    BuyBoxFooter = DynAccessor(682)
                    CanvasSequence = DynAccessor(683)
                    CloseBtn = DynAccessor(684)
                    Compensation = DynAccessor(685)
                    CurrencyKey = DynAccessor(686)
                    DeadlineWidget = DynAccessor(687)
                    Divider = DynAccessor(688)
                    EscBtn = DynAccessor(689)
                    Header = DynAccessor(690)
                    Lootbox = DynAccessor(691)
                    NyBoxWithToys = DynAccessor(692)
                    RotationReward = DynAccessor(693)
                    RotationVehicle = DynAccessor(694)
                    VehicleInfo = DynAccessor(695)
                    Video = DynAccessor(696)
                    VideoComponent = DynAccessor(697)

                shared = _shared()
                StorageView = DynAccessor(698)

                class _tooltips(DynAccessor):
                    __slots__ = ()
                    BonusGroupTooltip = DynAccessor(699)
                    CompensationTooltip = DynAccessor(700)
                    DeadlineTooltip = DynAccessor(701)
                    GuaranteedRewardTooltip = DynAccessor(702)
                    LootboxKeyTooltip = DynAccessor(703)
                    LootboxRotationTooltip = DynAccessor(704)
                    LootboxTooltip = DynAccessor(705)
                    LootboxTooltipExtended = DynAccessor(706)
                    OtherRewardsTooltip = DynAccessor(707)
                    ProbabilityButtonTooltip = DynAccessor(708)
                    ProbabilityGuaranteedRewardTooltip = DynAccessor(709)
                    ProbabilityStageButtonsTooltip = DynAccessor(710)
                    StatisticButtonTooltip = DynAccessor(711)

                tooltips = _tooltips()
                WelcomeScreen = DynAccessor(712)
    ...
    class _new_year(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            class _new_year(DynAccessor):
                __slots__ = ()
                AtmosphereLevelUp = DynAccessor(713)

                class _common(DynAccessor):
                    __slots__ = ()
                    FormatTextWithColorTags = DynAccessor(714)
                    IncreaseAnimation = DynAccessor(715)
                    NyPopoverDecorator = DynAccessor(716)
                    Shards = DynAccessor(717)

                    class _slots(DynAccessor):
                        __slots__ = ()
                        BreakDecorationSlot = DynAccessor(718)
                        DecorationSlot = DynAccessor(719)
                        EmptySlot = DynAccessor(720)
                        PetDecorationSlot = DynAccessor(721)
                        SlotPlaceholders = DynAccessor(722)

                    slots = _slots()
                    TokensStepper = DynAccessor(723)
                    VehicleBonus = DynAccessor(724)

                common = _common()
                CustomizationLevelUpView = DynAccessor(725)
                EnvironmentChangeView = DynAccessor(726)
                EnvSwitcherBtnTip = DynAccessor(727)
                EnvSwitcherBtnView = DynAccessor(728)

                class _loot_box(DynAccessor):
                    __slots__ = ()
                    LootBoxEntryView = DynAccessor(729)

                loot_box = _loot_box()
                MainView = DynAccessor(730)
                NyLeaderboardInfoView = DynAccessor(731)
                NyLeaderboardRecountView = DynAccessor(732)
                NyLeaderboardRewardView = DynAccessor(733)
                NyMainWidget = DynAccessor(734)
                NyProgressView = DynAccessor(735)
                NyQuestsRewardView = DynAccessor(736)
                OnboardingView = DynAccessor(737)
                PetRewardView = DynAccessor(738)
                PetStoryView = DynAccessor(739)

                class _popovers(DynAccessor):
                    __slots__ = ()
                    EnvSwitcherPopover = DynAccessor(740)
                    NyLootBoxPopover = DynAccessor(741)
                    NyPetItemActivatePopover = DynAccessor(742)
                    VehicleFilterPopover = DynAccessor(743)

                popovers = _popovers()
                RobotTvRewardsView = DynAccessor(744)
                RobotTvScreenView = DynAccessor(745)
                ...
                class _tooltips(DynAccessor):
                    ...
                    class _common(DynAccessor):
                        __slots__ = ()
                        DecorationContent = DynAccessor(746)
                        DecorationFooter = DynAccessor(747)
                        DecorationHeader = DynAccessor(748)
                        MenuInfo = DynAccessor(749)

                    common = _common()
                    CommonTooltip = DynAccessor(750)
                    CustomizationZoneTooltip = DynAccessor(751)
                    LevelUpWidgetTooltip = DynAccessor(752)
                    MenuMachineTooltip = DynAccessor(753)
                    NyBlockActivitiesTooltip = DynAccessor(754)
                    NyBoxWithToysTooltip = DynAccessor(755)
                    NyCurrencyCompensationTooltip = DynAccessor(756)
                    NyCurrencyTooltip = DynAccessor(757)
                    NyDecorationStateTooltip = DynAccessor(758)
                    NyDecorationTooltip = DynAccessor(759)
                    NyDiscountRewardTooltip = DynAccessor(760)
                    NyMainWidgetTooltip = DynAccessor(761)
                    NyMarketplaceTokenTooltip = DynAccessor(762)
                    NyPetBonusTooltip = DynAccessor(763)
                    NyPetDecorationTooltip = DynAccessor(764)
                    NyPetIndicatorTooltip = DynAccessor(765)
                    NyPetMailsTooltip = DynAccessor(766)
                    NyPetOverviewTooltip = DynAccessor(767)
                    NyPetTokenStepperTooltip = DynAccessor(768)
                    NyShopUnavailableTooltip = DynAccessor(769)
                    NyTotalBonusTooltip = DynAccessor(770)
                    SelectedRewardsTooltip = DynAccessor(771)

                tooltips = _tooltips()
                VehicleSelectionView = DynAccessor(772)

                class _views(DynAccessor):
                    __slots__ = ()
                    BuyToyView = DynAccessor(773)

                views = _views()
                WeeklyRewardsView = DynAccessor(774)
    ...
    class _story_mode(DynAccessor):
        ...
        class _battle(DynAccessor):
            __slots__ = ()
            EpilogueWindow = DynAccessor(775)
            OnboardingBattleResultView = DynAccessor(776)
            PrebattleWindow = DynAccessor(777)

        battle = _battle()

        class _common(DynAccessor):
            __slots__ = ()
            CongratulationsWindow = DynAccessor(778)
            MedalTooltip = DynAccessor(779)
            OnboardingQueueView = DynAccessor(780)

        common = _common()

        class _lobby(DynAccessor):
            __slots__ = ()
            BattleResultView = DynAccessor(781)
            MissionSelectionView = DynAccessor(782)
            MissionTooltip = DynAccessor(783)
    ...
    class _winback(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            class _tooltips(DynAccessor):
                __slots__ = ()
                CompensationTooltip = DynAccessor(785)
                SelectableRewardTooltip = DynAccessor(786)
                SelectedRewardsTooltip = DynAccessor(787)
                WidgetTooltipView = DynAccessor(788)

            tooltips = _tooltips()
            WinbackIntroView = DynAccessor(789)
            WinbackRewardView = DynAccessor(790)
            WinbackSelectableRewardView = DynAccessor(791)
            WinbackWidgetView = DynAccessor(792)

        lobby = _lobby()
        ProgressionMainView = DynAccessor(793)

    winback = _winback()
    Anchor = DynAccessor(794)
    ArmoryYardDemoView = DynAccessor(795)

    class _child_views_demo(DynAccessor):
        __slots__ = ()
        ChildDemoView = DynAccessor(796)
        MainView = DynAccessor(797)

    child_views_demo = _child_views_demo()
    ClientgwMockView = DynAccessor(798)
    Comp7DemoPageView = DynAccessor(799)
    ComponentsDemo = DynAccessor(800)
    DataLayerDemoView = DynAccessor(801)
    DataTrackerDemo = DynAccessor(802)
    DemoContextMenu = DynAccessor(803)
    Easings = DynAccessor(804)
    GameLoadingDebugView = DynAccessor(805)
    GFCharset = DynAccessor(806)
    GFComponents = DynAccessor(807)
    GFDemoPopover = DynAccessor(808)
    GFDemoRichTooltipWindow = DynAccessor(809)
    GFDemoWindow = DynAccessor(810)
    GFHooksDemo = DynAccessor(811)
    GFInjectView = DynAccessor(812)
    GFInputCases = DynAccessor(813)
    GfMarkerDemoView = DynAccessor(814)
    GFSimpleTooltipWindow = DynAccessor(815)
    GFWebSubDemoWindow = DynAccessor(816)

    class _gf_dialogs_demo(DynAccessor):
        __slots__ = ()
        DefaultDialogProxy = DynAccessor(817)
        GFDialogsDemo = DynAccessor(818)

        class _sub_views(DynAccessor):
            __slots__ = ()
            DummyContent = DynAccessor(819)
            DummyFooter = DynAccessor(820)
            DummyIcon = DynAccessor(821)
            DummyStepper = DynAccessor(822)
            DummyTitle = DynAccessor(823)
            DummyTopRight = DynAccessor(824)
    ...
    class _gf_viewer(DynAccessor):
        __slots__ = ()
        GFViewerWindow = DynAccessor(825)

    gf_viewer = _gf_viewer()

    class _igb_demo(DynAccessor):
        __slots__ = ()
        BrowserFullscreenWindow = DynAccessor(826)
        BrowserWindow = DynAccessor(827)
        MainView = DynAccessor(828)

    igb_demo = _igb_demo()
    LocaleDemo = DynAccessor(829)
    MediaWrapperDemo = DynAccessor(830)
    MixBlendMode = DynAccessor(831)
    MixBlendModeAnimation = DynAccessor(832)
    ModeSelectorDemo = DynAccessor(833)
    ModeSelectorToolsetView = DynAccessor(834)

    class _mttv(DynAccessor):
        __slots__ = ()
        CustomView = DynAccessor(835)
        MttvEntityView = DynAccessor(836)
        MttvKeyframeInfoView = DynAccessor(837)
        MttvKeyframeView = DynAccessor(838)
        MttvTimelineView = DynAccessor(839)
        MttvToolsView = DynAccessor(840)

    mttv = _mttv()
    PluralLocView = DynAccessor(841)
    PropsSupportDemo = DynAccessor(842)
    ReactSpringVizualizer = DynAccessor(843)
    SelectableRewardDemoView = DynAccessor(844)
    StructuralDataBindDemo = DynAccessor(845)

    class _sub_views_demo(DynAccessor):
        __slots__ = ()
        GFSubViewsDemo = DynAccessor(846)

        class _sub_views(DynAccessor):
            __slots__ = ()
            CustomizationCartProxy = DynAccessor(847)
            DailyProxy = DynAccessor(848)
            ProgressiveItemsViewProxy = DynAccessor(849)

        sub_views = _sub_views()

    sub_views_demo = _sub_views_demo()
    SurfaceView = DynAccessor(850)
    UILoggerDemo = DynAccessor(851)
    VideoSupportView = DynAccessor(852)
    W2CTestPageWindow = DynAccessor(853)