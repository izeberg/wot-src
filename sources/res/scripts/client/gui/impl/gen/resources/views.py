...
class Views(DynAccessor):
    ...
    class _new_year(DynAccessor):
        ...
        class _lobby(DynAccessor):
            ...
            class _new_year(DynAccessor):
                ...
                NyLeaderboardRewardView = DynAccessor(727)
                NyMainWidget = DynAccessor(728)
                NyProgressView = DynAccessor(729)
                NyQuestsRewardView = DynAccessor(730)
                OnboardingView = DynAccessor(731)
                PetRewardView = DynAccessor(732)
                PetStoryView = DynAccessor(733)

                class _popovers(DynAccessor):
                    __slots__ = ()
                    EnvSwitcherPopover = DynAccessor(734)
                    NyDecorationsPopover = DynAccessor(735)
                    NyLootBoxPopover = DynAccessor(736)
                    NyPetItemActivatePopover = DynAccessor(737)
                    VehicleFilterPopover = DynAccessor(738)

                popovers = _popovers()
                RobotTvRewardsView = DynAccessor(739)
                RobotTvScreenView = DynAccessor(740)
                ...
                class _tooltips(DynAccessor):
                    ...
                    class _common(DynAccessor):
                        __slots__ = ()
                        DecorationContent = DynAccessor(741)
                        DecorationFooter = DynAccessor(742)
                        DecorationHeader = DynAccessor(743)
                        MenuInfo = DynAccessor(744)

                    common = _common()
                    CommonTooltip = DynAccessor(745)
                    CustomizationZoneTooltip = DynAccessor(746)
                    LevelUpWidgetTooltip = DynAccessor(747)
                    MenuMachineTooltip = DynAccessor(748)
                    NyBlockActivitiesTooltip = DynAccessor(749)
                    NyBoxWithToysTooltip = DynAccessor(750)
                    NyCurrencyCompensationTooltip = DynAccessor(751)
                    NyCurrencyTooltip = DynAccessor(752)
                    NyDecorationStateTooltip = DynAccessor(753)
                    NyDecorationTooltip = DynAccessor(754)
                    NyDiscountRewardTooltip = DynAccessor(755)
                    NyMainWidgetTooltip = DynAccessor(756)
                    NyMarketplaceTokenTooltip = DynAccessor(757)
                    NyPetBonusTooltip = DynAccessor(758)
                    NyPetDecorationTooltip = DynAccessor(759)
                    NyPetIndicatorTooltip = DynAccessor(760)
                    NyPetMailsTooltip = DynAccessor(761)
                    NyPetOverviewTooltip = DynAccessor(762)
                    NyPetTokenStepperTooltip = DynAccessor(763)
                    NyShopUnavailableTooltip = DynAccessor(764)
                    NyTotalBonusTooltip = DynAccessor(765)
                    SelectedRewardsTooltip = DynAccessor(766)

                tooltips = _tooltips()
                VehicleSelectionView = DynAccessor(767)

                class _views(DynAccessor):
                    __slots__ = ()
                    BuyToyView = DynAccessor(768)

                views = _views()
                WeeklyRewardsView = DynAccessor(769)
    ...
    class _story_mode(DynAccessor):
        ...
        class _battle(DynAccessor):
            __slots__ = ()
            EpilogueWindow = DynAccessor(770)
            OnboardingBattleResultView = DynAccessor(771)
            PrebattleWindow = DynAccessor(772)

        battle = _battle()

        class _common(DynAccessor):
            __slots__ = ()
            CongratulationsWindow = DynAccessor(773)
            MedalTooltip = DynAccessor(774)
            OnboardingQueueView = DynAccessor(775)

        common = _common()

        class _lobby(DynAccessor):
            __slots__ = ()
            BattleResultView = DynAccessor(776)
            MissionSelectionView = DynAccessor(777)
            MissionTooltip = DynAccessor(778)
    ...
    class _winback(DynAccessor):
        __slots__ = ()
        BattleQuestAwardsView = DynAccessor(780)
        ...
        class _lobby(DynAccessor):
            ...
            class _popovers(DynAccessor):
                __slots__ = ()
                WinbackLeaveModePopoverView = DynAccessor(781)

            popovers = _popovers()

            class _tooltips(DynAccessor):
                __slots__ = ()
                CompensationTooltip = DynAccessor(782)
                MainRewardTooltip = DynAccessor(783)
                ModeInfoTooltip = DynAccessor(784)
                SelectableRewardTooltip = DynAccessor(785)
                SelectedRewardsTooltip = DynAccessor(786)
                WidgetTooltipView = DynAccessor(787)

            tooltips = _tooltips()
            WinbackDailyQuestsIntroView = DynAccessor(788)
            WinbackIntroView = DynAccessor(789)
            WinbackLeaveModeDialogView = DynAccessor(790)
    ...
    mttv = _mttv()
    PluralLocView = DynAccessor(842)
    PropsSupportDemo = DynAccessor(843)
    ReactSpringVizualizer = DynAccessor(844)
    SelectableRewardDemoView = DynAccessor(845)
    StructuralDataBindDemo = DynAccessor(846)

    class _sub_views_demo(DynAccessor):
        __slots__ = ()
        GFSubViewsDemo = DynAccessor(847)

        class _sub_views(DynAccessor):
            __slots__ = ()
            CustomizationCartProxy = DynAccessor(848)
            DailyProxy = DynAccessor(849)
            ProgressiveItemsViewProxy = DynAccessor(850)

        sub_views = _sub_views()

    sub_views_demo = _sub_views_demo()
    SurfaceView = DynAccessor(851)
    UILoggerDemo = DynAccessor(852)
    VideoSupportView = DynAccessor(853)
    W2CTestPageWindow = DynAccessor(854)