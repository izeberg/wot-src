...
class PersonalMissionsRewardsView(ViewImpl):
    __slots__ = ('__questId', '__tooltipData', '__questUserShortName', '__questUserDescr',
                 '__selectedBonuses', '__viewType', '__countSelectableBonuses', '__operationID')
    ...
    def _getEvents(self):
        return (
         (
          self.__itemsCache.onSyncCompleted, self.__updateData),
         (
