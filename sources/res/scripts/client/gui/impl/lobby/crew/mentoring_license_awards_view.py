...
class MentoringLicenseAwardsView(BaseCrewSubView):
    ...
    def _getEvents(self):
        return (
         ...
         (
          self.viewModel.onRedirect, self._onRedirect),
         (
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.lobby.crew.tooltips.MentoringLicenseTooltip():
            return MentoringLicenseTooltip(self.numItems)
        return super(MentoringLicenseAwardsView, self).createToolTipContent(event=event, contentID=contentID)
    ...
    def _primaryButtonVisible(self):
        ...
        if currVehicle is None:
            ...
            if not currVehicle.hasCrew:
                return False
            if currVehicle.isInBattle:
                return False
            return True
