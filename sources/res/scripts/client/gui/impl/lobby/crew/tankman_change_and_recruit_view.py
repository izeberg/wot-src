...
class TankmanChangeAndRecruitView(ViewImpl):
    __slots__ = ('__tankmanInvID', '__tankman', '__isRecruit', '__selectedVehType',
                 '__currentVehicle', '__nativeVehicle', '__keepInVeh', '__firstNamesList',
                 '__lastNamesList', '__firstNameIdx', '__lastNameIdx', '__filterState',
                 '__dataProviders', '__retrainKey', '__isSpecialtyChanged', '__retrain',
                 '__selectedIcon', '__selectedIconID', '__selectedSkinID', '__recruitData',
                 '__slotID', '__predefinedNations', '__predefinedRoles', '__predefinedVehicle',
                 '__predefinedVehicleType', '__selectedNationID', '__isFemale', '__initialVehicle',
                 '__selectedSpecialty', '__predefinedData', '__predefinedRole', '__selectedNationName',
                 '__stats')
