...
class CustomizationToolbarProvider(EventsHandler, CustomizationSettingsSerializable):
    __slots__ = ('__mainView', '__ctx', '__eventsManager', '__isShownToolbar', '__attachedAnchor',
                 '__isApplyToAllSeasonsSelected', '__isItemAppliedToAll', '__displayedProgressionLevel',
                 '__inscriptionController', 'onApplyToAllSeasonsSelectedChanged')
    ...
    def __fillScaleSubButtons(self, subButtons):
        if self.__attachedAnchor.slotType == GUI_ITEM_TYPE.CAMOUFLAGE:
            ...
            if self.__attachedAnchor.slotType == GUI_ITEM_TYPE.PROJECTION_DECAL:
