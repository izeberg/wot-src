...
import typing, BigWorld, ScaleformFileLoader, adisp
...
SpecialRewardData = namedtuple('SpecialRewardData', ('sourceName', 'congratsType',
                                                     'congratsSourceId', 'vehicleName',
                                                     'vehicleLvl', 'vehicleIsElite',
                                                     'vehicleType', 'backToSingleOpening',
                                                     'isGuaranteedReward'))
SpecialGuestRewardData = namedtuple('SpecialGuestRewardData', ('congratsType', 'backToSingleOpening'))
SpecialAttachmentRewardData = namedtuple('SpecialAttachmentRewardData', ('congratsType',
                                                                         'congratsSourceId',
                                                                         'backToSingleOpening'))
...
class LootBoxHideableView(ViewImpl):
    __slots__ = ('_showHideCloseHandler', '_hideCompleteCallback', '_isMemoryRiskySystem',
                 '_isCanClose', '_holdByViews', '__holdIDs', '__videoFiles', '__invokeFinalize')
    _VIDEOS = []
    ...
    def __init__(self, settings):
        ...
        self._holdByViews = (
         lobbyViews.new_year.views.NyRewardKitSpecialReward(),
...
def getTooltipContent(event, storedTooltipData):
    ...
    if tooltipContent is not None:
        ...
        if event.contentID == tooltipContentRes.NyResourceTooltip():
            return NyResourceTooltip(event.getArgument('type'))
        if event.contentID == R.views.lobby.new_year.tooltips.NyGuaranteedRewardTooltip():
