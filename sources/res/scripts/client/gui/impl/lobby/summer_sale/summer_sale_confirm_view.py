...
class SummerSaleConfirmView(DialogTemplateView):
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        self.setSubView(DefaultDialogPlaceHolders.CONTENT, SimpleTextContent(str(backport.text(R.strings.event.summerSales.confirm.content.placeHolder(), warning='%(warning)s')), imageSubstitutions=[
         imageContent]))
