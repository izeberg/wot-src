    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as (viewModel):
            ...
            if not self.__isVehicleSelected:
                ...
                makeRewardModels({k:v for k, v in self.__rewards.iteritems() if k == 'vehicles' if k == 'vehicles'}, viewModel.getMainRewards(), viewModel.getRewards(), tooltipData=self.__tooltipData)
        return
