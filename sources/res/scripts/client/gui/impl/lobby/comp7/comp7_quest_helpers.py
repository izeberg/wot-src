...
def getComp7OfferWeeklyQuestsRewardToken(ctrl=None):
    actualSeasonNumber = ctrl.getActualSeasonNumber()
    if actualSeasonNumber:
        return offerWeeklyQuestsRewardTokenBySeasonNumber(actualSeasonNumber)
...
def hasAvailableWeeklyQuestsOfferGiftTokens(itemsCache=None, comp7Controller=None):
    ...
    if season is None:
        ...
        return offerWeeklyQuestsRewardGiftTokenBySeasonNumber(season) in itemsCache.items.tokens.getTokens()
