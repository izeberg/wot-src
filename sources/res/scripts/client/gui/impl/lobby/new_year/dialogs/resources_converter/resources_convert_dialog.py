...
class ResourcesConvertDialogView(FullScreenDialogBaseView):
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.mono.holiday_ops.dialogs.converter.resources_convert_dialog())
        settings.args = args
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return super(ResourcesConvertDialogView, self).createToolTipContent(event, contentID)
