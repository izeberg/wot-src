...
class HOChallengeHeadquarters(SubModelPresenter):
    ...
    def initialize(self, *args, **kwargs):
        super(HOChallengeHeadquarters, self).initialize(self, *args, **kwargs)
        self.__fillModel()

    def _getEvents(self):
        events = super(HOChallengeHeadquarters, self)._getEvents()
        return events + (
         (
         ...
         (
          self.__celebrityController.onCelebActionTokenUpdated, self.__onCelebActionTokenUpdated))
