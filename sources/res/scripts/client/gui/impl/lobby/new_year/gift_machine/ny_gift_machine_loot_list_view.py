...
class NyGiftMachineLootListWindow(LobbyWindow):
    ...
    def __init__(self):
        super(NyGiftMachineLootListWindow, self).__init__(wndFlags=WindowFlags.WINDOW | WindowFlags.WINDOW_FULLSCREEN, content=NyGiftMachineLootListView(R.views.mono.holiday_ops.ho_gift_machine_loot_list()), layer=WindowLayer.OVERLAY)