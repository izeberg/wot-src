...
class HOGiftMachineDisplayView(ViewImpl):
    __itemsCache = dependency.descriptor(IItemsCache)

    def __init__(self):
        settings = ViewSettings(R.views.mono.holiday_ops.gift_machine_display())
        settings.model = NyGiftMachineDisplayViewModel()
        self.__state = None
        super(HOGiftMachineDisplayView, self).__init__(settings)
        return
    ...
    def _onLoading(self, *args, **kwargs):
        super(HOGiftMachineDisplayView, self)._onLoading(*args, **kwargs)
