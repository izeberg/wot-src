...
from gui.shared.events import NyGladeVisibilityEvent, NyCelebrityStoriesEvent
from gui.shared.view_helpers.blur_manager import CachedBlur
from gui.impl.lobby.new_year.observers import HolidayOpsObjectStateObserver
from helpers import dependency, uniprof
from gui.shared import EVENT_BUS_SCOPE, g_eventBus, event_dispatcher
...
_CHANGE_LAYERS_VISIBILITY = (
 WindowLayer.VIEW, WindowLayer.WINDOW)
...
class ChallengeStoriesView(ViewImpl):
    ...
    def __init__(self, level, justReceived):
        settings = ViewSettings(R.views.mono.holiday_ops.challenge_stories_view())
    ...
    def _onLoaded(self, *args, **kwargs):
        super(ChallengeStoriesView, self)._onLoaded(*args, **kwargs)
    ...
    def __onEventStateChanged(self):
        if not self.__nyController.isEnabled():
            ...
            ChallengeState.goTo(instantly=True)
