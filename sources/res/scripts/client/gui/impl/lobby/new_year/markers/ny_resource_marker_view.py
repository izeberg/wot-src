...
class NyResourceMarkerView(NyHangarMarkerView):
 ...
 L.  55         0  LOAD_GLOBAL           0  'getCollectingCooldownTime'
                3  CALL_FUNCTION_0       0  None
                6  STORE_FAST            1  'cooldownTime'

 L.  56         9  LOAD_GLOBAL           1  'getNYGeneralConfig'
 ...
 L.  63       106  LOAD_FAST             3  'isInFriendHangar'
