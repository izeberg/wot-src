...
from gui.shared.event_dispatcher import showHolidayOpsLootBoxBuyWindow, showLootBoxEntry
...
class NyResourcesConvertPopover(PopOverViewImpl):
    ...
    def __init__(self):
        settings = ViewSettings(R.views.mono.holiday_ops.popovers.ho_resources_convert_popover())
    ...
    def createToolTipContent(self, event, contentID):
        if contentID == R.views.mono.holiday_ops.tooltips.ho_resource_converter_info_tooltip():
    ...
    def _onLoading(self, *args, **kwargs):
        ...
        with self.viewModel.transaction() as (model):
            ...
            model.setIsExternal(not hasBigBoxes)
