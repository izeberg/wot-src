...
from gui.impl.gen.view_models.views.lobby.new_year.views.glade.toy_model import SlotState, SlotType, ToyModel
...
class NyToysList(object):
    ...
    def __onApplySelection(self, args):
        ...
        if toyID != INVALID_TOY_ID and self.__slotID in inventoryToys and toyID in inventoryToys[self.__slotID] and (inventoryToys[self.__slotID][toyID].getCount() or toyID == self.__installedToyID):
