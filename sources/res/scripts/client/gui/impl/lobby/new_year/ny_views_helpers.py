...
from gui.shared.event_dispatcher import showBrowserOverlayView, showBundlePurchaseDialog, showPetPurchaseDialog
...
_EXECUTE_ACTIONS = {'showBundlePurchaseDialog': showBundlePurchaseDialog, 
   'showPetPurchaseDialog': showPetPurchaseDialog}
...
_MARKETPLACE_BONUSES_ORDER = ({'getName': 'customizations', 'getIcon': 'style'}, {'getName': 'customizations', 'getIcon': 'projectionDecal'})
