...
class ShopOverlayView(ViewImpl):
    __slots__ = ('__rewardKitStatistics', '__lastStatisticsResetFailed', '__tabsController',
                 '__url')
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return super(ShopOverlayView, self).createToolTipContent(event, contentID)
    ...
    def _getListeners(self):
        return (
         (
          events.LootboxesEvent.ON_STATISTICS_RESET, self.__onStatisticsReset, EVENT_BUS_SCOPE.LOBBY),
         (
          NY_OVERLAY_PAGE_CHANGED_EVENT, self.__onMainPageChanged),
         (
          events.HideWindowEvent.HIDE_OVERLAY_BROWSER_VIEW, self.__handleBrowserClose, EVENT_BUS_SCOPE.LOBBY))
