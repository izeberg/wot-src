...
class HOResourceMarkerView(HOHangarMarkerView):
    RESOURCE_NAME = ''
    ...
    def __init__(self, *args, **kwargs):
        settings = ViewSettings(R.views.mono.holiday_ops_marker.ho_resource_marker())
        settings.model = NyResourceMarkerModel()
        settings.args = args
        settings.kwargs = kwargs
        self.__lockForCustomAnimation = False
        super(HOResourceMarkerView, self).__init__(settings)
    ...
    def _onLoading(self, *args, **kwargs):
        super(HOResourceMarkerView, self)._onLoading(*args, **kwargs)
 ...
 L.  53         0  LOAD_GLOBAL           0  'getCollectingCooldownTime'
                3  CALL_FUNCTION_0       0  None
                6  STORE_FAST            1  'cooldownTime'

 L.  54         9  LOAD_GLOBAL           1  'getNYGeneralConfig'
 ...
 L.  60        85  LOAD_GLOBAL          10  'super'
               88  LOAD_GLOBAL          11  'HOResourceMarkerView'
               91  LOAD_FAST             0  'self'
 ...
 L.  61       106  LOAD_FAST             3  'isInFriendHangar'
...
Parse error at or near `RETURN_END_IF' instruction at offset 127
    ...
    def _getEvents(self):
        ...
        return super(HOResourceMarkerView, self)._getEvents() + (
         (
...
class HOCrystalMarkerView(HOResourceMarkerView):
    RESOURCE_NAME = Resource.CRYSTAL


class HOEmeraldMarkerView(HOResourceMarkerView):
    RESOURCE_NAME = Resource.EMERALD


class HOAmberMarkerView(HOResourceMarkerView):
    RESOURCE_NAME = Resource.AMBER


class HOIronMarkerView(HOResourceMarkerView):
