...
class NyGiftMachineView(SceneRotatableView, SelectableLogicPresenter):
    __slots__ = ('__cameraHelper', '__displayView', '__storedReward', '__isCameraHelperActive',
                 '__isMessageBarVisible', '__redButtonPressCallbackID', '__returnToIdleCallbackID',
                 '__onCoinsUpdateCallbackID', '__buttonPressCount', '__isButtonBlocked')
    ...
    def createToolTipContent(self, event, contentID):
        ...
        return super(NyGiftMachineView, self).createToolTipContent(event, contentID)
