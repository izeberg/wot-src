...
from gui.impl.lobby.new_year.states import FriendsState, switchToFriendView
...
class ResourceBoxPresenter(SubModelPresenter):
    ...
    def __init__(self, viewModel, parentView):
        ...
        self.__tooltips = {}
        self.__isInFriendHangar = self.__friendsService.isInFriendHangar
        return
    ...
    def _getEvents(self):
        ...
        return events + (
         (
          viewModel.onGetReward, self.__onGetReward),
         (
    ...
    def __getTokenCount(self):
        ...
        if self.__piggyBankProgressToken is not None:
            return self.__itemsCache.items.tokens.getTokenCount(self.__piggyBankProgressToken)
        else:
            return 0
