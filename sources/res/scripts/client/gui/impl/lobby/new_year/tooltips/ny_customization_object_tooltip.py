...
class NyCustomizationObjectTooltip(ViewImpl):
    ...
    def __init__(self, objectName):
        settings = ViewSettings(R.views.mono.holiday_ops.tooltips.ho_customization_object_tooltip())
    ...
    def __getState():
        ...
        if cooldownTime > eventEndTimeTill:
            return ResourceCollectState.FINISHED
        return ResourceCollectState.COLLECTED