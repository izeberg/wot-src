...
BONUSES_ORDER = (
 NyATMReward.DOG, NyATMReward.CAT, NyATMReward.MARKETPLACE, 'tmanToken', 'customizations_style', 'vehicles', 'playerBadges', 'singleAchievements', 'nyCoin') + CREEBOOK_NATION_ORDER + ('crewBooks',
                                                                                                                                                                                        'booster_credits',
                                                                                                                                                                                        'booster_xp') + BLUEPRINT_NATION_ORDER + ('BlueprintNationFragmentCongrats',
                                                                                                                                                                                                                                  'booster_crew_xp',
...
class AwardNotificationBase(HONotification):
