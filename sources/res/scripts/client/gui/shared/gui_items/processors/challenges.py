...
class ActivateChallengeProcessor(_ChallengesProcessor):
    ...
    def _successHandler(self, code, ctx=None):
        ...
        if challenge is not None:
            return makeSuccess(userMsg=backport.text(msgKey.success.text()), msgType=SystemMessages.SM_TYPE.ChallengesActivation, msgData={'title': backport.text(msgKey.success.title(), challengeName=challenge.name)})
        else:
            return makeSuccess()
