...
_integralRangeFormat = {'rounder': backport.getIntegralFormat, 'separator': _DASH}
...
ITEMS_PARAMS_LIST = {ITEM_TYPES.vehicleRadio: ('radioDistance', 'weight'), 
 ...
 'flameMaxDistance', 'stunMaxDuration', 'shotSpeedAccelerated'), 
   ...
   ITEM_TYPES.vehicleGun: (
                         ...
                         'stunMaxDurationList', DISPERSION_RADIUS, DUAL_ACCURACY_COOLING_DELAY,
                         'aimingTime', 'maxShotDistance', 'weight', AUTOSHOOT_FLAME_CHANGE_SHELL_TIME,
...
MULTIPLE_FORMATTED_PARAMS = {CHASSIS_REPAIR_TIME: (
                       ...
                       ChangeCondition(useMultiTrackParallelChassisRepairTime, CHASSIS_REPAIR_TIME_MULTITRACK_PARALLEL)), 
   'autoReloadTime': (
                    ChangeCondition(useAutoReloadBoost, 'autoReloadTimeBoost'),)}
