...
VETERAN_BONUS = CurrencyRecord(recordNames=('veteranCreditsFactor100', ), subtractRecords=(), valueExtractor=getMainValue, capsToBeChecked=None, label=_STR_PATH.veteranBonus, modifiers=(), showZeroValue=False, currencyType=CurrenciesConstants.CREDITS)
