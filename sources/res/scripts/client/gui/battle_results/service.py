...
class BattleResultsService(IBattleResultsService):
    ...
    GF_BONUS_TYPES = frozenset([ARENA_BONUS_TYPE.REGULAR, ARENA_BONUS_TYPE.RANDOM_NP2, ARENA_BONUS_TYPE.EPIC_RANDOM,
     ARENA_BONUS_TYPE.TRAINING, ARENA_BONUS_TYPE.TOURNAMENT_REGULAR,
