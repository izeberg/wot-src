...
__all__ = ('TOTAL_VO_META', 'MULTI_TEAM_TABS_BLOCK', 'REGULAR_TABS_BLOCK', 'RANDOM_TABS_BLOCK',
           'VEHICLE_PROGRESS_STATS_BLOCK', 'BATTLE_PASS_PROGRESS_STATS_BLOCK', 'QUESTS_PROGRESS_STATS_BLOCK',
           'DOG_TAGS_PROGRESS_STATS_BLOCK', 'REGULAR_COMMON_STATS_BLOCK', 'REGULAR_PERSONAL_STATS_BLOCK',
           'REGULAR_TEAMS_STATS_BLOCK', 'REGULAR_TEXT_STATS_BLOCK', 'CLAN_TEXT_STATS_BLOCK',
           'STRONGHOLD_BATTLE_COMMON_STATS_BLOCK', 'STRONGHOLD_PERSONAL_STATS_BLOCK',
           'STRONGHOLD_TEAMS_STATS_BLOCK', 'CYBER_SPORT_BLOCK', 'RANKED_COMMON_STATS_BLOCK',
           'RANKED_TEAMS_STATS_BLOCK', 'RANKED_RESULTS_BLOCK', 'RANKED_PERSONAL_STATS_BLOCK',
           'RANKED_RESULTS_STATUS_BLOCK', 'BOOTCAMP_RESULTS_BLOCK', 'RANKED_ENABLE_ANIMATION_BLOCK',
           ...
           'RANKED_RESULTS_STATE_BLOCK', 'BR_TOTAL_VO_META', 'BR_TABS_BLOCK', 'BR_TEAM_STATS_BLOCK',
           'BR_PERSONAL_STATS_BLOCK', 'BR_COMMON_STATS_BLOCK', 'MAPS_TRAINING_RESULTS_BLOCK',
           'COMP7_PERSONAL_STATS_BLOCK', 'TOURNAMENT_COMP7_PERSONAL_STATS_BLOCK',
