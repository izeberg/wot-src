...
class ButtonPlugin(HintPanelPlugin):
    __slots__ = ('__commandKey', '_isActive', '__settings', '__isShown', '__isInDisplayPeriod',
                 '__callbackDelayer', '_isVisible', '__settingKey', '__settingSectionName',
                 '_localeRes', '__hintPriority', '__hintContext')
    _sessionProvider = dependency.descriptor(IBattleSessionProvider)
    _HINTS_AMOUNT = 3
    _HINT_TIMEOUT = 6
