...
def getViewSettings():
    ...
    return (
     ViewSettings(VIEW_ALIAS.BOB_BATTLE_PAGE, BobPage, 'bobBattlePage.swf', WindowLayer.VIEW, None, ScopeTemplates.DEFAULT_SCOPE),
...
def getBusinessHandlers():
    return (
     BattlePageBusinessHandler(VIEW_ALIAS.BOB_BATTLE_PAGE),)