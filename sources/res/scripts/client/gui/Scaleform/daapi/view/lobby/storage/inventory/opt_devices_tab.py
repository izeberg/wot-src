...
class OptDevicesTabView(StorageDevicesTabViewMeta):
    ...
    def _initFilter(self):
        ...
        self.as_initModulesFilterS({'enabled': True, 'selectedIndex': index, 'data': self._getFilterItems()})
    ...
    def __updateRestoreButton(self):
        ...
        self.as_setRestoreButtonDataS({'isVisible': deletedCount > 0, 'counterValue': deletedCount})
