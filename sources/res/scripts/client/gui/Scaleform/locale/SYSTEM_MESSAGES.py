...
class SYSTEM_MESSAGES(object):
    ...
    NEWYEAR_CELEBRITYCHALLENGE_FULLQUESTREWARD_TITLE = '#system_messages:newYear/celebrityChallenge/fullQuestReward/title'
    NEWYEAR_CELEBRITYCHALLENGE_FULLQUESTREWARD_FINAL_TITLE = '#system_messages:newYear/celebrityChallenge/fullQuestReward/final/title'
    ...
    ALL_ENUM = (
     ...
     NEWYEAR_CELEBRITYCHALLENGE_FULLQUESTREWARD_TITLE,
     NEWYEAR_CELEBRITYCHALLENGE_FULLQUESTREWARD_FINAL_TITLE,
