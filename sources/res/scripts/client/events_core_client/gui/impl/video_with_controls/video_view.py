...
SoundSpacePrerequisites = namedtuple('SoundSpaceSettingsPrerequisites', ('entranceStates',
                                                                         'exitStates'))
VideoPrerequisites = namedtuple('VideoPrerequisites', ('videoPath', 'subtitlesPath',
                                                       'isControlsVisible', 'isSubtitlesVisible',
                                                       'soundSpace'))
