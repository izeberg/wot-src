...
class NOTIFICATION_TYPE(object):
    ...
    HO_DOG_REMINDER = 33
    HO_MARKETPLACE_AVAILABLE = 34
    HO_FRIEND_RESOURCE_COLLECTING_AVAILABLE = 35
    HO_RESOURCE_REMINDER = 36
    HO_FRIEND_RESOURCE_REMINDER = 37
    HO_NO_FRIENDS_REMINDER = 38
    OTG_REWARD_AVAILABLE = 39
    RANGE = None
