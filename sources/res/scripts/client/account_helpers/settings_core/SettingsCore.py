...
class SettingsCore(ISettingsCore):
    ...
    def init(self):
        ...
        self.__options = options.SettingsContainer(graphicSettings + (
         ...
         (
          GAME.DISABLE_THERMAL_VISION_EFFECT,
          options.AccountDumpSetting(GAME.DISABLE_THERMAL_VISION_EFFECT, GAME.DISABLE_THERMAL_VISION_EFFECT)),
         (
          GAME.DISABLE_THERMAL_VISION_SECTOR_EFFECT,
          options.AccountDumpSetting(GAME.DISABLE_THERMAL_VISION_SECTOR_EFFECT, GAME.DISABLE_THERMAL_VISION_SECTOR_EFFECT)),
         (
