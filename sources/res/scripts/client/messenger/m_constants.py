...
class SCH_CLIENT_MSG_TYPE(object):
    ...
    GF_SM_TYPE = 39
    NY_EVENT_BUTTON_MESSAGE = 501
    NY_RESOURCES_CONVERTED_MESSAGE = 502
    NY_GUEST_QUEST_COMPLETED_MESSAGE = 503
    NY_COLLECTING_MESSAGE = 504
    NY_CURRENCY_FINANCIAL_OPERATION_MESSAGE = 507
    NY_COLLECTION_REWARD_MESSAGE = 508
    NY_SACK_BOUGHT_MESSAGE = 511