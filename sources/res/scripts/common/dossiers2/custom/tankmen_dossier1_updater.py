...
__TANKMAN_LAYOUT_10 = [
 ...
 'xp', 'maxXP', 'battlesCount', 'wins', 'losses', 'survivedBattles', 'winAndSurvived',
 'frags', 'frags8p', 'fragsBeast', 'shots', 'directHits', 'spotted', 'damageDealt',
 'damageReceived', 'treesCut', 'capturePoints', 'droppedCapturePoints', 'sniperSeries',
 'maxSniperSeries', 'invincibleSeries', 'maxInvincibleSeries', 'diehardSeries',
 'maxDiehardSeries', 'killingSeries', 'maxKillingSeries', 'piercingSeries',
 'maxPiercingSeries', 'battleHeroes',
 'warrior', 'invader', 'sniper', 'defender', 'steelwall', 'supporter', 'scout',
 'medalKay', 'medalSamokhin', 'medalGudz', 'medalPoppel', 'medalAbrams', 'medalLeClerc',
 'medalLavrinenko', 'medalEkins', 'medalUshakov', 'medalOrlik', 'medalOskin', 'medalKrysov',
 'medalBurda', 'medalBillotte', 'medalKolobanov', 'medalFadin',
 'beasthunter', 'titleSniper', 'invincible', 'diehard', 'raider',
 'handOfDeath', 'armorPiercer', 'kamikaze', 'lumberjack']
__TANKMAN_LAYOUT_11 = [
 '_version',
 'battlesCount',
 'warrior', 'invader', 'sniper', 'defender', 'steelwall', 'supporter', 'scout', 'evileye',
 'medalUshakov', 'medalOrlik', 'medalOskin', 'medalKrysov',
 'medalBurda', 'medalBillotte', 'medalKolobanov', 'medalFadin',
 'medalHeroesOfRassenai', 'medalDeLaglanda', 'medalTrubin',
 'medalErohin', 'medalHoroshilov', 'medalLister']
__TANKMAN_LAYOUT_12 = [
 '_version',
 'battlesCount',
 'warrior', 'invader', 'sniper', 'defender', 'steelwall', 'supporter', 'scout', 'evileye',
 'medalUshakov', 'medalOrlik', 'medalOskin', 'medalKrysov',
 'medalBurda', 'medalBillotte', 'medalKolobanov', 'medalFadin', 'medalRadleyWalters',
...
__TANKMAN_LAYOUT_13 = [
 ...
 'medalBurda', 'medalBillotte', 'medalKolobanov', 'medalFadin', 'medalRadleyWalters',
 'medalBrunoPietro', 'medalLyubushkin', 'medalPascucci', 'medalDumitru', 'medalKhazov',
 'medalNikolas', 'medalLafayettePool', 'heroesOfRassenay']
__TANKMAN_LAYOUT_14 = [
 '_version',
 'battlesCount',
 'warrior', 'invader', 'sniper', 'defender', 'steelwall', 'supporter', 'scout', 'evileye',
 ...
 'medalBurda', 'medalBillotte', 'medalKolobanov', 'medalFadin', 'medalRadleyWalters',
 'medalBrunoPietro', 'medalLyubushkin', 'medalPascucci', 'medalDumitru', 'medalKhazov',
 'medalNikolas', 'medalLafayettePool', 'heroesOfRassenay', 'medalDeLanglade',
 'medalTrubin']
...
def updateDossierCompDescr(compDescr):
    ...
    if verDescr == 10:
        ...
        for record in ['warrior', 'invader', 'sniper', 'defender', 'steelwall', 'supporter', 'scout',
         'evileye', 'medalUshakov', 'medalOrlik', 'medalOskin', 'medalKrysov', 'medalBurda',
         'medalBillotte', 'medalKolobanov', 'medalFadin', 'medalRadleyWalters',
         'medalBrunoPietro', 'medalLyubushkin', 'medalPascucci', 'medalDumitru', 'medalKhazov',
         'medalNikolas', 'medalLafayettePool', 'heroesOfRassenay', 'medalDeLanglade',
         'medalTrubin']:
