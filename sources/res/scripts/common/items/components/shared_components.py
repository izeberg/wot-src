    ...
    def readMechanicsParams(cls, xmlCtx, section, readModifiers):
        if not cls.MECHANICS_NAME:
            ...
            if mechanicSection is None:
                return
            return cls._readMechanicsParams(mechanicCtx, mechanicSection, readModifiers)
...
class ImprovedRammingParams(MechanicsDynParams):
    __slots__ = MechanicsDynParams.__slots__ + ('damageBonusStageSize', 'trackDamageBonusStageSize',
                                                'reductionDamageBonusStageSize',
...
class PillboxSiegeModeParams(MechanicsDynParams):
    __slots__ = MechanicsDynParams.__slots__ + ('switchDriveToPillboxTime', 'switchSiegeToPillboxTime',
                                                'switchPillboxToSiegeTime', 'switchPillboxToDriveTime')
...
class ChargeableBurstParams(MechanicsDynParams, GunMechanicsParams):
    __slots__ = MechanicsDynParams.__slots__ + GunMechanicsParams._GUN_SLOTS + ('penetrationCount',
                                                                                'burstDispersionFactor')
...
class TargetDesignatorParams(MechanicsParams):
    __slots__ = ('__damageIncomeFactors', 'cooldownTime', 'deployTime', 'spottedMarkedTime',
                 'unspottedMarkedTime')
