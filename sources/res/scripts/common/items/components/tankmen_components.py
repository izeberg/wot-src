...
class SPECIAL_VOICE_TAG(object):
    ...
    BP_18_M = ('tankmen_bp18_5', 'tankmen_bp18_6', 'tankmen_bp18_7', 'tankmen_bp18_8',
               'tankmen_bp18_9')
    ALL = (
     BUFFON, SABATON, OFFSPRING, RACER, RACER_EN, CELEBRITY_2021, MIHO, YHA, ALICE, DARJEELING, CELEBRITY_2022, DAY_OF_COSMONAUTICS_21, SABATON_2021, QUICKY_BABY, WITCHES_CREW, CELEBRITY_2023, HAND_OF_BLOOD, NAMELESS, EDELWEISS, SKILL_4_LTU, TALKTOME_GOOSE, CELEBRITY_2024, CYGAN, ERIKA, MIKA, MARTY_VOLE, MT_LB_1, CELEBRITY_2025) + BATTLE_OF_BLOGGERS + BATTLE_OF_BLOGGERS_2021 + G_I_JOE_TWITCH_2021 + WHITE_TIGER_EVENT_2021 + G_I_JOE_2022 + WHITE_TIGER_EVENT_2022 + BPH_2022 + WHITE_TIGER_EVENT_2023 + BP_12_M + BP_H2 + BP_13 + CTM_24 + BP_14_M + WHITE_TIGER_EVENT_2024 + BP_15_M + BP_H4 + BP_16_M + BP_17_DC_M + BP_18_M
...
class SPECIAL_CREW_TAG(object):
    ...
    ALL = (
     SABATON, OFFSPRING, MIHO, YHA, WITCHES_CREW, MIKA_CREW, DARJEELING_CREW)
