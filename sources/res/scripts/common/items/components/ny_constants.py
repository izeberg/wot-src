...
class YEARS_INFO(object):
    ...
    _COLLECTION_TYPES_BY_YEAR = {YEARS.YEAR18: ToySettings.OLD, 
       ...
       YEARS.YEAR26: ToySettings.NEW + ToySettings.DOG}
...
RANDOM_TYPE = 'random'
CURRENT_YEAR_BADGE_ID = 224
PREVIOUS_YEARS_BADGE_IDS = (86, 100, 107, 128, 141, 172)
...
class CelebrityQuestTokenParts(object):
    ...
    MARATHON_MASTERY_PREFIX = 'NY_mrthn_clbty_mastery'
    SEPARATOR = ':'
    TYPE = 'type'
    QUEST = 'quest'
    DAY = 'day'
    ...
    SEAL = 'seal'
    FULL_SEAL = 'full_seal'
    SEAL_TOKEN = 'NY_clbty:seal'
    FULL_SEAL_TOKEN = 'NY_clbty:full_seal'
    REROLL = 'reroll'
    REWARD = 'reward'
    FULL_REWARD = 'full_reward'
    REWARDS = (
     REWARD, FULL_REWARD)
    QUEST_TYPES = (DAY, TYPE, QUEST)
    QUEST_IDS = (QUEST,) + REWARDS
    ...
    def isCelebrityFullQuestID(cls, fullQuestID):
        ...
        if parts is None:
            ...
            questPrefix, questType, questID = parts
            return questPrefix == cls.PREFIX and questType.startswith(cls.TYPE) and questID.startswith(cls.QUEST)
    ...
    def makeQuestIDFromFullQuestID(cls, fullQuestID):
        ...
        if parts is None:
            ...
            _, questType, questID = parts
            return cls.makeQuestID(questType, questID)

    @classmethod
    def makeRewardsQuestIDFromFullQuestID(cls, fullQuestID, fullReward=False):
        parts = cls.__splitQuestID(fullQuestID)
        if parts is None:
            return
        else:
            _, questType, questInfo = parts
            questInfo = questInfo.split('_')
            day = ('_').join((cls.DAY, str(questInfo[(-1)])))
            return cls.makeQuestID(day, cls.FULL_REWARD if fullReward else cls.REWARD)

    @classmethod
    def makeUpcomingRewardsQuestID(cls, dayNum, fullReward=False):
    ...
    def makeRewardsQuestIDFromQuestID(cls, questID, tokens):
        ...
        if parts is None:
            ...
            _, _, battleQuestID = parts
            for fullQuestToken in celebrityTokens:
                parts = cls.__splitQuestID(fullQuestToken)
                _, _, questID = parts
                if battleQuestID == questID:
                    return cls.makeQuestID(questID, cls.REWARD)
 ...
 L. 720        42  LOAD_DEREF            0  'cls'
               45  LOAD_ATTR             1  'getTypeFromFullQuestID'
               48  LOAD_FAST             1  'qAID'
               51  CALL_FUNCTION_1       1  None
               54  LOAD_ATTR             2  'split'
               57  LOAD_CONST               '_'
               60  CALL_FUNCTION_1       1  None
               63  UNPACK_SEQUENCE_2     2 
               66  STORE_FAST            7  '_'
               69  STORE_FAST            8  'qATypenumber'

 L. 721        72  LOAD_DEREF            0  'cls'
               75  LOAD_ATTR             1  'getTypeFromFullQuestID'
               78  LOAD_FAST             2  'qBID'
               81  CALL_FUNCTION_1       1  None
               84  LOAD_ATTR             2  'split'
               87  LOAD_CONST               '_'
               90  CALL_FUNCTION_1       1  None
               93  UNPACK_SEQUENCE_2     2 
               96  STORE_FAST            7  '_'
               99  STORE_FAST            9  'qBTypenumber'

 L. 727       102  LOAD_GLOBAL           3  'all'
              105  LOAD_CLOSURE          0  'cls'
              111  LOAD_GENEXPR             '<code_object <genexpr>>'
              114  MAKE_CLOSURE_0        0  None
              117  LOAD_FAST             3  'qAType'
              120  LOAD_FAST             5  'qBType'
              123  BUILD_TUPLE_2         2 
              126  GET_ITER         
              127  CALL_FUNCTION_1       1  None
              130  CALL_FUNCTION_1       1  None
              133  POP_JUMP_IF_FALSE   203  'to 203'
              136  LOAD_GLOBAL           4  'cmp'
              139  LOAD_DEREF            0  'cls'
              142  LOAD_ATTR             5  'QUEST_TYPES'
              145  LOAD_ATTR             6  'index'
              148  LOAD_FAST             3  'qAType'
              151  CALL_FUNCTION_1       1  None
              154  LOAD_DEREF            0  'cls'
              157  LOAD_ATTR             5  'QUEST_TYPES'
              160  LOAD_ATTR             6  'index'
              163  LOAD_FAST             5  'qBType'
              166  CALL_FUNCTION_1       1  None
              169  CALL_FUNCTION_2       2  None
              172  JUMP_IF_TRUE_OR_POP   206  'to 206'
              175  LOAD_GLOBAL           4  'cmp'
              178  LOAD_FAST             4  'qANum'
              181  LOAD_FAST             6  'qBNum'
              184  CALL_FUNCTION_2       2  None
              187  JUMP_IF_TRUE_OR_POP   206  'to 206'
              190  LOAD_GLOBAL           4  'cmp'
              193  LOAD_FAST             8  'qATypenumber'
              196  LOAD_FAST             9  'qBTypenumber'
              199  CALL_FUNCTION_2       2  None
              202  RETURN_END_IF    
            203_0  COME_FROM           187  '187'
            203_1  COME_FROM           172  '172'
            203_2  COME_FROM           133  '133'
              203  LOAD_CONST               0
              206  RETURN_VALUE     
               -1  RETURN_LAST      

Parse error at or near `RETURN_END_IF' instruction at offset 202
    ...
    @classmethod
    def isRewardQuestID(cls, questID):
        parts = cls.__splitQuestID(questID)
        if parts is None:
            return False
        else:
            questPrefix, _, questInfo = parts
            return questPrefix == cls.PREFIX and any(questInfo.startswith(reward) for reward in cls.REWARDS)
    ...
    @classmethod
    def __splitQuestID(cls, questID, partsCount=3):
...
class NYFriendServiceDataTokens(object):
    CELEBRITY_QUEST_COMPLETED = CelebrityQuestTokenParts.SEAL_TOKEN
...
NY_PET_TOKEN = 'ny:pet_obtained'
NY_PET_TOKEN_LIFETIME = 24 * 39# Decompile failed :(