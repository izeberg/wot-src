...
class Equipment(Artefact):
    __slots__ = ('equipmentType', 'reuseCount', 'cooldownSeconds', 'soundNotification',
                 ...
                 'clientSelector', 'activationWWSoundFeedback', 'deactivationWWSoundFeedback',
                 'ownerPrefab', 'usagePrefab', 'playerMessagesKey', 'code', 'ctrlItems',
                 'activationWWSoundFeedback', 'deactivationWWSoundFeedback', 'activationSound',
                 'deactivationSound', 'refillSound')
...
class AreaOfEffectEquipment(Equipment, TooltipConfigReader, SharedCooldownConsumableConfigReader, ArcadeEquipmentConfigReader, EffectsConfigReader):
    __slots__ = ('delay', 'duration', 'lifetime', 'shotsNumber', 'areaRadius', 'areaLength',
                 ...
                 'explodeDestructible', 'areaUsedPrefab', 'areaAccurateCollision',
                 'wwsoundFiring') + TooltipConfigReader._SHARED_TOOLTIPS_CONSUMABLE_SLOTS + SharedCooldownConsumableConfigReader._SHARED_COOLDOWN_CONSUMABLE_SLOTS + ArcadeEquipmentConfigReader._SHARED_ARCADE_SLOTS + EffectsConfigReader._EFFECTS_SLOTS_
