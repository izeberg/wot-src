...
ACHIEVEMENTS = ('warrior', 'invader', 'sniper', 'sniper2', 'mainGun', 'defender', 'steelwall',
                ...
                'medalPascucci', 'medalDumitru', 'medalBrunoPietro', 'medalLyubushkin',
                'heroesOfRassenay', 'medalDeLanglade', 'medalTrubin', 'raider', 'kamikaze',
                'huntsman', 'bombardier', 'luckyDevil', 'ironMan', 'sturdy', 'alaric',
                'lumberjack', 'medalBrothersInArms', 'medalCrucialContribution',
                ...
                'hb24Medal', 'hb25MedalOffence', 'hb25MedalDefence')
