...
class MuseumVehicleView(BaseTransitionView):
    ...
    def _initialize(self, *args, **kwargs):
        ...
        g_eventBus.handleEvent(events.LobbyInterfaceEvent(events.LobbyInterfaceEvent.TOGGLE_VISIBILITY, ctx={'visible': False, 'messengerBarVisible': False}), EVENT_BUS_SCOPE.LOBBY)
    ...
    def _finalize(self):
        ...
        self.__uiLogger.log()
        self.__unloadSpace()
        g_eventBus.handleEvent(events.LobbyInterfaceEvent(events.LobbyInterfaceEvent.TOGGLE_VISIBILITY, ctx={'visible': True, 'messengerBarVisible': True}), EVENT_BUS_SCOPE.LOBBY)
