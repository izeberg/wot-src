...
_ABILITY_TYPE_BY_EQUIP_NAME = {GrinchAbilities.GRINCH_REPAIR_KIT: AbilityTypeEnum.REPAIRKIT, GrinchAbilities.GRINCH_HEAL: AbilityTypeEnum.HEAL, 
   ...
   GrinchAbilities.GRINCH_JUMP: AbilityTypeEnum.JUMP, 
   GrinchAbilities.GRINCH_MISSILES: AbilityTypeEnum.MISSILES, 
   GrinchAbilities.GRINCH_DART: AbilityTypeEnum.DART, 
   GrinchAbilities.GRINCH_SONAR: AbilityTypeEnum.SONAR, 
   GrinchAbilities.GRINCH_RAM: AbilityTypeEnum.RAM}
    ...
    def _onEquipmentAdded(self, intCD, item):
        ...
        if idx is None:
            ...
            def addEquipment(model):
                ...
                model.setIsActive(False)
                model.setIsEnabled(not item.isLocked())
                model.setDuration(item.getDescriptor().duration or 0)
