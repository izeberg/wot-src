...
class GrinchRibbonsPanel(BattleRibbonsPanel):
    ...
    def _getRibbonsConfig(self):
        ...
        config.extend([
         ...
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.DAMAGED_BY_DART,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.damageByDart())],
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.ABILITY_ASSIST_SONAR,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.abilityAssistSonar())],
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.DART_DAMAGE_CAUSED,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.dartDamageCaused())],
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.SONAR_CAUSED_DAMAGE,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.sonarCausedDamage())],
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.SONAR_DAMAGE,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.sonarDamage())],
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.MISSILE_DAMAGE_CAUSED,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.missileDamageCaused())],
         [
          GRINCH_BATTLE_EFFICIENCY_TYPES.MISSILE_DAMAGE_RECEIVED,
          backport.text(R.strings.grinch.ribbon.efficiencyRibbons.missileDamageReceived())]])
        return config
