...
from grinch.gui.Scaleform.daapi.view.battle.indicators import grinchCreateDamageIndicator
...
_CONFIG = ComponentsConfig(config=(
 ...
 (
  BATTLE_CTRL_ID.AMMO, (DynamicAliases.GRINCH_EQUIPMENT_BINDER,)),
 (
  BATTLE_CTRL_ID.HIT_DIRECTION, (DynamicAliases.GRINCH_HIT_DIRECTION,))), viewsConfig=(
 (
 ...
 (
  DynamicAliases.GRINCH_HIT_DIRECTION, grinchCreateDamageIndicator)))
