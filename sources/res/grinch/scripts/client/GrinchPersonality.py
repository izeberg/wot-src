...
from AvatarInputHandler import AIH_COMMANDS_DESC_MAP
...
from grinch.avatar_input_handler.commands.ability_binder import AbilityBinderCommand
...
from grinch.gui.game_control.performance_analyzer import PerformanceAnalyzer
from grinch.gui.grinch_gui_constants import FUNCTIONAL_FLAG
...
from grinch.messenger.formatters.service_channel import GrinchCongratulationsMessageFormatter
...
from gui.shared.system_factory import registerAwardControllerHandler, registerIgnoredModeForAutoSelectVehicle
...
class ClientGrinchBattleMode(GrinchBattleMode):
    ...
    def _client_gameControllers(self):
        ...
        return (
         (
          IGrinchController, GrinchController, False),
         (
          IPerformanceAnalyzer, PerformanceAnalyzer, False))
    ...
    def _client_messengerClientFormatters(self):
        ...
        return {grinch_gui_constants.SCH_CLIENT_MSG_TYPE.GRINCH_EVENT_STATE: GrinchEventStateMessageFormatter(), 
           ...
           grinch_gui_constants.SCH_CLIENT_MSG_TYPE.GRINCH_CONGRATULATIONS_MESSAGE: GrinchCongratulationsMessageFormatter()}
    ...
    def _client_platoonLayouts(self):
        ...
        return [
         (
          EPlatoonLayout.MEMBER, PlatoonLayout(R.views.grinch.lobby.platoon.MembersWindow(), MembersWindow))]
    ...
    def _client_hangarEventBannerType(self):
        from grinch.gui.impl.lobby.banner_entry_point.grinch_event_banner import GrinchEventBanner
        return GrinchEventBanner

    @property
    def _client_lowPriorityWulfWindows(self):
        from gui.impl.gen import R
        return [R.views.grinch.lobby.platoon.MembersWindow()]
...
def preInit():
    ...
    AIH_COMMANDS_DESC_MAP[ARENA_BONUS_TYPE_CAPS.GRINCH] = (
     AbilityBinderCommand,)
...
def init():
    ...
    g_overrideScaleFormViewsConfig.initExtensionLobbyPackages(__name__, [
     ...
     'grinch_progression.gui.impl.lobby'])
