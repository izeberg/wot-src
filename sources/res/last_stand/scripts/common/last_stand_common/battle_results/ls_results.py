...
BATTLE_RESULTS = [
 (
  'ls_phase', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_ALL),
 (
  'ls_phasesCount', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_ALL),
 (
  'ls_artefactKeys', int, 0, None, 'skip', ENTRY_TYPE.VEHICLE_ALL),
 (
