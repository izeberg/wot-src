...
class _LSConfig(namedtuple('_LSConfig', ('isEnabled', 'isBattlesEnabled', 'startDate', 'endDate', 'rewardsSettings',
                         'artefactsSettings', 'dailyBonusSettings', 'vehicles', 'shop',
                         'isPromoScreenEnabled', 'isIntroVideoEnabled', 'prominentBonus',
                         'modeSelectorShowRewards'))):
    __slots__ = ()
