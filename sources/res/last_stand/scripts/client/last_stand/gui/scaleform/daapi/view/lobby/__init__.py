...
def getContextMenuHandlers():
    ...
    return (
     (
      LS_CM_HANDLER_TYPE.LS_BATTLE_RESULTS, user_cm_handlers.AppealCMHandler),)
...
def getViewSettings():
    ...
    return (
     ComponentSettings(LAST_STAND_HANGAR_ALIASES.LS_ENTRY_POINT, LSEntryPoint, ScopeTemplates.DEFAULT_SCOPE),
