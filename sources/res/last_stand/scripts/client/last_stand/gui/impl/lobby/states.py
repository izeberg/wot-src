...
class LastStandRewardPathState(SFViewLobbyState):
    ...
    def getNavigationDescription(self):
        ...
        infos = [
         LobbyStateDescription.Info(type=LobbyStateDescription.Info.Type.INFO, onMoreInfoRequested=showMetaIntroView, tooltipBody=backport.text(R.strings.last_stand_lobby.rewardPath.aboutTooltip()))]
