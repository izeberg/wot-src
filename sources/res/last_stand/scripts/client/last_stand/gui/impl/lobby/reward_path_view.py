...
class RewardPathView(BaseView, LobbyHeaderVisibility):
    ...
    def __fillArtefacts(self, tx):
        ...
        for artefact in self.lsArtefactsCtrl.artefactsSorted():
            ...
            self.__bonusCache.update(fillRewards(artefact.bonusRewards, artefactVM.getRewards(), self._MAX_BONUSES_IN_VIEW, self.__idGen, skipBonuses=[
             'slots']))
    ...
    def __fillDifficultyMissions(self, tx):
        ...
        for level in self.difficultyCtrl.getLevelsInfo():
            ...
            self.__bonusCache.update(fillRewards(self.lsDifficultyMissionsCtrl.getAggregatedMissionRewards(level.level.value), difficultyVM.getAggregatedRewards(), self._MAX_BONUSES_IN_VIEW, self.__idGen, skipBonuses=[
             'slots']))
