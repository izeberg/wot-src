...
AMMO_SECTIONS_ALTERNATIVE = (LSTankSetupConstants.LS_CONSUMABLES, TankSetupConstants.SHELLS,
 TankSetupConstants.OPT_DEVICES, TankSetupConstants.BATTLE_BOOSTERS)
...
class LSHangarAmmunitionGroupsController(AmmunitionGroupsController):
    ...
    def setNextPreset(self):
        ...
        ammoPanels = [
         R.views.last_stand.mono.lobby.ammunition_setup(), R.views.lobby.tanksetup.AmmunitionPanel()]
