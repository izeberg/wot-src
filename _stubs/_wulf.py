...
class PyGuiApplication(pybind11_object):
	...
	layoutManager = property(lambda self: None)
...
class PyObjectLayoutManager(PyObjectEntity):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
	...
	__module__ = '_wulf'
	def __new__(*args, **kwargs): pass
	__qualname__ = 'PyObjectLayoutManager'
	def __reduce__(*args, **kwargs): pass
	def __reduce_ex__(*args, **kwargs): pass
	def __repr__(*args, **kwargs): pass
	def __setattr__(*args, **kwargs): pass
	...
	def __subclasshook__(*args, **kwargs): pass
	def bindPyObject(self, *args, **kwargs): pass
	def createAbsoluteLayout(self, *args, **kwargs): pass
	def destroyLayout(self, *args, **kwargs): pass
	object = property(lambda self: None)
...
class PyObjectResourceManager(PyObjectEntity):
	...
	def getRootNode(self, *args, **kwargs): pass
...
class PyObjectView(PyObjectEntity):
	...
	sharedLayoutID = property(lambda self: None)
	def unbindPyObject(self, *args, **kwargs): pass
...
class ResAccessor(pybind11_object):
	def __call__(self, *args, **kwargs): pass
	def __copy__(self, *args, **kwargs): pass
	def __deepcopy__(self, *args, **kwargs): pass
	def __delattr__(*args, **kwargs): pass
	__doc__ = "Accessor for a node in the WULF resource tree (the 'R' object).\nAttribute access (R.images.foo) walks the tree; each attribute returns\nanother ResAccessor for the child node. Mirrors the Gameface-side DynAccessor."
	def __format__(*args, **kwargs): pass
	...
	def length(self, *args, **kwargs): pass
	def num(self, *args, **kwargs): pass
