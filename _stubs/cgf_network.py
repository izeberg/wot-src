...
class NetworkEntity(IComponent):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
...
class NetworkKinematicTransformComponent(IComponent):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
...
class NetworkTransformComponent(IComponent):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
...
class PredefinedReplicablesSystem(ISystem):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
	...
	__module__ = 'cgf_network'
	def __new__(*args, **kwargs): pass
	__qualname__ = 'PredefinedReplicablesSystem'
	def __reduce__(*args, **kwargs): pass
	def __reduce_ex__(*args, **kwargs): pass
	def __repr__(*args, **kwargs): pass
	def __setattr__(*args, **kwargs): pass
...
class ReplicableComponent(IComponent):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
...
class ReplicationPointComponent(IComponent):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
...
class SpaceReplicationPointTag(IComponent):
	def __delattr__(*args, **kwargs): pass
	__doc__ = None
	def __format__(*args, **kwargs): pass
	def __getattribute__(*args, **kwargs): pass
...
def createPrefabInstanceAuto(*args, **kwargs): pass
...
def findReplicableComponentPropertiesByTypeInQueue(*args, **kwargs): pass
def getGameObjectByNetworkID(*args, **kwargs): pass
def getNetworkID(*args, **kwargs): pass
def loadAndCreatePrefabAuto(*args, **kwargs): pass
def loadAndCreatePrefabAutoWithParent(*args, **kwargs): pass
def loadAndCreateReplicablePrefab(*args, **kwargs): pass
def loadAndCreateReplicablePrefabWithParent(*args, **kwargs): pass
