...
class WGPickleOptimizationSettings(pybind11_object):
	ALL = WGPickleOptimizationSettings.ALL
	FLOAT = WGPickleOptimizationSettings.FLOAT
	INT = WGPickleOptimizationSettings.INT
	LONG = WGPickleOptimizationSettings.LONG
	STRING = WGPickleOptimizationSettings.STRING
	def __delattr__(*args, **kwargs): pass
	__doc__ = u'Members:\n\n  INT\n\n  ALL\n\n  FLOAT\n\n  STRING\n\n  LONG'
	__entries = {u'INT': (WGPickleOptimizationSettings.INT, None), u'ALL': (WGPickleOptimizationSettings.ALL, None), u'FLOAT': (WGPickleOptimizationSettings.FLOAT, None), u'STRING': (WGPickleOptimizationSettings.STRING, None), u'LONG': (WGPickleOptimizationSettings.LONG, None)}
	...
	__members__ = {u'INT': WGPickleOptimizationSettings.INT, u'ALL': WGPickleOptimizationSettings.ALL, u'FLOAT': WGPickleOptimizationSettings.FLOAT, u'STRING': WGPickleOptimizationSettings.STRING, u'LONG': WGPickleOptimizationSettings.LONG}
	__module__ = 'wg_pickle'
	def __ne__(self, *args, **kwargs): pass
	def __new__(*args, **kwargs): pass
	__qualname__ = 'WGPickleOptimizationSettings'
	def __reduce__(*args, **kwargs): pass
	def __reduce_ex__(*args, **kwargs): pass
